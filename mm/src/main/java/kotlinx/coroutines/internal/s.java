...
public class s<T> extends a<T> implements e {
    ...
    public s(f fVar, d<? super T> dVar) {
        super(fVar, true);
        this.TWf = dVar;
    }
    ...
    public void fM(Object obj) {
        ...
        this.TWf.resumeWith(w.a(obj, this.TWf));
