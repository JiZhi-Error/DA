...
public final class j {
    ...
    public static final k gf(Object obj) {
        k kVar;
        k kVar2;
        AppMethodBeat.i(118115);
        r rVar = (r) (!(obj instanceof r) ? null : obj);
        if (rVar != null && (kVar2 = rVar.TWe) != null) {
            kVar = kVar2;
        } else if (obj == null) {
