...
public interface IX5WebViewClient {
    ...
    void onContentSizeChanged(IX5WebViewBase iX5WebViewBase, int i2, int i3);

    void onDetectedBlankScreen(IX5WebViewBase iX5WebViewBase, String str, int i2);
    ...
    void onPageFinished(IX5WebViewBase iX5WebViewBase, int i2, int i3, String str);

    void onPageFinished(IX5WebViewBase iX5WebViewBase, String str);

    void onPageStarted(IX5WebViewBase iX5WebViewBase, int i2, int i3, String str, Bitmap bitmap);
    ...
    void onReceivedError(IX5WebViewBase iX5WebViewBase, int i2, String str, String str2);
    ...
    void onScaleChanged(IX5WebViewBase iX5WebViewBase, float f2, float f3);
