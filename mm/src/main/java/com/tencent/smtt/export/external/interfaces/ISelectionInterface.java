...
public interface ISelectionInterface {
    ...
    boolean isSelectionViewVisible();

    void onRetrieveFingerSearchContextResponse(String str, String str2, int i2);

    void onSelectCancel();

    void onSelectionBegin(Rect rect, Rect rect2, int i2, int i3, short s);

    void onSelectionBeginFailed(int i2, int i3);

    void onSelectionChange(Rect rect, Rect rect2, int i2, int i3, short s);
