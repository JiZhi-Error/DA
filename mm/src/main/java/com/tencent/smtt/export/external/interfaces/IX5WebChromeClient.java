...
public interface IX5WebChromeClient {
    ...
    void onExceededDatabaseQuota(String str, String str2, long j2, long j3, long j4, QuotaUpdater quotaUpdater);
    ...
    void onProgressChanged(IX5WebViewBase iX5WebViewBase, int i2);

    void onReachedMaxAppCacheSize(long j2, long j3, QuotaUpdater quotaUpdater);
    ...
    void onShowCustomView(View view, int i2, CustomViewCallback customViewCallback);
