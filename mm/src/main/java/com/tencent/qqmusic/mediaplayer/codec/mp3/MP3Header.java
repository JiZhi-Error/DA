...
class MP3Header {
    ...
    private int[][] samplingRate = {new int[]{11025, 12000, TXRecordCommon.AUDIO_SAMPLERATE_8000, 0}, new int[]{0, 0, 0, 0}, new int[]{22050, 24000, 16000, 0}, new int[]{44100, 48000, 32000, 0}};
    ...
    public void decode(int i2) {
        int i3 = 17;
        this.verID = (i2 >> 19) & 3;
        this.layer = 4 - ((i2 >> 17) & 3);
        this.protection_bit = (i2 >> 16) & 1;
        this.bitrate_index = (i2 >> 12) & 15;
        this.sampling_frequency = (i2 >> 10) & 3;
        this.padding = (i2 >> 9) & 1;
        this.mode = (i2 >> 6) & 3;
        this.mode_extension = (i2 >> 4) & 3;
