...
public abstract class FaceManager {
    ...
    public abstract void authenticate(CryptoObject cryptoObject, CancellationSignal cancellationSignal, int i2, AuthenticationCallback authenticationCallback, Handler handler);
