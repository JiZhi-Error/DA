...
public class ShareElfFile implements Closeable {
    ...
    public ShareElfFile(File file) {
        ...
        for (int i3 = 0; i3 < this.sectionHeaders.length; i3++) {
            readUntilLimit(channel, allocate, "failed to read shdr.");
            this.sectionHeaders[i3] = new SectionHeader(allocate, this.elfHeader.eIndent[4]);
        }
        if (this.elfHeader.eShStrNdx > 0) {
            ...
            for (SectionHeader sectionHeader : sectionHeaderArr) {
    ...
    public static void assertInRange(int i2, int i3, int i4, String str) {
        if (i2 < i3 || i2 > i4) {
    ...
    public static int getFileTypeByMagic(java.io.File r6) {
        /*
    ...
    public static class ElfHeader {
        ...
        private ElfHeader(FileChannel fileChannel) {
            ...
            if (this.eIndent[0] == Byte.MAX_VALUE && this.eIndent[1] == 69 && this.eIndent[2] == 76 && this.eIndent[3] == 70) {
                ShareElfFile.assertInRange(this.eIndent[4], 1, 2, "bad elf class: " + ((int) this.eIndent[4]));
