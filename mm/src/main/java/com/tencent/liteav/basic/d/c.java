...
public class c {
    ...
    private synchronized void o() {
        ...
        if (q()) {
            ...
            TXCLog.i("CloudConfig", "load config(system aec):" + this.f358j.f363d + "," + this.f358j.f364e + "," + this.f358j.f366g + "," + this.f358j.f367h + ", model = " + Build.MODEL + ", manufacturer = " + Build.MANUFACTURER + "， board = " + Build.BOARD);
        }
