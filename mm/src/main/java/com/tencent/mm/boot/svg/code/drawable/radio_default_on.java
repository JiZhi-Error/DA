...
public class radio_default_on extends c {
    ...
    public int doCommand(int i2, Object... objArr) {
        switch (i2) {
            ...
            case 2:
                ...
                canvas.save();
                float[] matrixFloatArray = c.setMatrixFloatArray(instanceMatrixArray, 1.0f, 0.0f, -392.0f, 0.0f, 1.0f, -141.0f, 0.0f, 0.0f, 1.0f);
                instanceMatrix.reset();
                instanceMatrix.setValues(matrixFloatArray);
                canvas.concat(instanceMatrix);
                canvas.save();
                float[] matrixFloatArray2 = c.setMatrixFloatArray(matrixFloatArray, 1.0f, 0.0f, 392.0f, 0.0f, 1.0f, 141.0f, 0.0f, 0.0f, 1.0f);
                instanceMatrix.reset();
                ...
                instancePath2.cubicTo(22.16f, 16.0f, 16.0f, 22.16f, 16.0f, 30.0f);
                instancePath2.cubicTo(16.0f, 37.84f, 22.16f, 44.0f, 30.0f, 44.0f);
                instancePath2.cubicTo(37.84f, 44.0f, 44.0f, 37.84f, 44.0f, 30.0f);
                instancePath2.cubicTo(44.0f, 22.16f, 37.84f, 16.0f, 30.0f, 16.0f);
