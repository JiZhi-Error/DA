...
public class icons_outlined_folder extends c {
    ...
    public int doCommand(int i2, Object... objArr) {
        switch (i2) {
            ...
            case 2:
                ...
                instancePath.moveTo(56.4f, 15.0f);
                ...
                instancePath.lineTo(56.4f, 15.0f);
                instancePath.close();
                instancePath.moveTo(56.4f, 18.6f);
                instancePath.lineTo(3.6f, 18.6f);
                instancePath.lineTo(3.6f, 44.4f);
                instancePath.lineTo(56.4f, 44.4f);
                instancePath.lineTo(56.4f, 18.6f);
                instancePath.close();
