...
public class app_brand_desktop_delete_highlight extends c {
    ...
    public int doCommand(int i2, Object... objArr) {
        switch (i2) {
            ...
            case 2:
                ...
                canvas.save();
                float[] matrixFloatArray = c.setMatrixFloatArray(instanceMatrixArray, 1.0f, 0.0f, 12.0f, 0.0f, 1.0f, 1.0f, 0.0f, 0.0f, 1.0f);
                ...
                float[] matrixFloatArray2 = c.setMatrixFloatArray(matrixFloatArray, 1.0f, 0.0f, 17.0f, 0.0f, 1.0f, 32.0f, 0.0f, 0.0f, 1.0f);
                instanceMatrix.reset();
                ...
                instancePath2.lineTo(2.0f, -2.6645353E-15f);
                instancePath2.cubicTo(2.5522847f, -2.6645353E-15f, 3.0f, 0.44771522f, 3.0f, 1.0f);
                instancePath2.lineTo(3.0f, 21.0f);
                instancePath2.cubicTo(3.0f, 21.552284f, 2.5522847f, 22.0f, 2.0f, 22.0f);
                instancePath2.lineTo(1.0f, 22.0f);
                instancePath2.cubicTo(0.44771522f, 22.0f, 0.0f, 21.552284f, 0.0f, 21.0f);
                ...
                float[] matrixFloatArray3 = c.setMatrixFloatArray(matrixFloatArray2, 0.9659258f, -0.25881904f, 3.58819f, 0.25881904f, 0.9659258f, -2.3841858E-7f, 0.0f, 0.0f, 1.0f);
                instanceMatrix.reset();
                ...
                instancePath6.cubicTo(-4.5474735E-13f, 6.4477153f, 0.44771522f, 6.0f, 1.0f, 6.0f);
                instancePath6.lineTo(47.0f, 6.0f);
                instancePath6.cubicTo(47.552284f, 6.0f, 48.0f, 6.4477153f, 48.0f, 7.0f);
