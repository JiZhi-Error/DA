...
public class background_tipsbar_dark extends c {
    ...
    public int doCommand(int i2, Object... objArr) {
        switch (i2) {
            ...
            case 2:
                ...
                canvas.save();
                float[] matrixFloatArray = c.setMatrixFloatArray(instanceMatrixArray, 1.0f, 0.0f, -279.0f, 0.0f, 1.0f, -529.0f, 0.0f, 0.0f, 1.0f);
                ...
                float[] matrixFloatArray2 = c.setMatrixFloatArray(matrixFloatArray, 311.0f, 0.0f, 279.0f, 0.0f, 601.0f, 529.0f, 0.0f, 0.0f, 1.0f);
                instanceMatrix.reset();
