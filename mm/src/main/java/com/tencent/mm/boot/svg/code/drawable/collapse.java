...
public class collapse extends c {
    ...
    public int doCommand(int i2, Object... objArr) {
        switch (i2) {
            ...
            case 2:
                ...
                canvas.save();
                float[] matrixFloatArray = c.setMatrixFloatArray(instanceMatrixArray, -1.0f, 1.2246469E-16f, 12.0f, -1.2246469E-16f, -1.0f, 12.0f, 0.0f, 0.0f, 1.0f);
                ...
                instancePath.close();
                canvas.save();
                float[] matrixFloatArray2 = c.setMatrixFloatArray(matrixFloatArray, -1.8369701E-16f, -1.0f, 10.666667f, 1.0f, -1.8369701E-16f, 3.333333f, 0.0f, 0.0f, 1.0f);
                instanceMatrix.reset();
                ...
                float[] matrixFloatArray3 = c.setMatrixFloatArray(matrixFloatArray2, -1.0f, 1.2246469E-16f, 5.361044f, -1.2246469E-16f, -1.0f, 9.34036f, 0.0f, 0.0f, 1.0f);
                instanceMatrix.reset();
