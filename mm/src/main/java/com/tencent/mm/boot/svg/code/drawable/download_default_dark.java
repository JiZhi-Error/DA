...
public class download_default_dark extends c {
    ...
    public int doCommand(int i2, Object... objArr) {
        switch (i2) {
            ...
            case 2:
                ...
                canvas.save();
                float[] matrixFloatArray = c.setMatrixFloatArray(instanceMatrixArray, 1.0f, 0.0f, -264.0f, 0.0f, 1.0f, -40.0f, 0.0f, 0.0f, 1.0f);
                instanceMatrix.reset();
                instanceMatrix.setValues(matrixFloatArray);
                canvas.concat(instanceMatrix);
                canvas.save();
                float[] matrixFloatArray2 = c.setMatrixFloatArray(matrixFloatArray, 1.0f, 0.0f, 264.0f, 0.0f, 1.0f, 40.0f, 0.0f, 0.0f, 1.0f);
                instanceMatrix.reset();
                ...
                canvas.restore();
                canvas.save();
                float[] matrixFloatArray4 = c.setMatrixFloatArray(matrixFloatArray3, 1.0f, 0.0f, 4.451329f, 0.0f, 1.0f, 4.496923f, 0.0f, 0.0f, 1.0f);
                instanceMatrix.reset();
