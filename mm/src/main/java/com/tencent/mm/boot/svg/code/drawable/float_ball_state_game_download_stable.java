...
public class float_ball_state_game_download_stable extends c {
    ...
    public int doCommand(int i2, Object... objArr) {
        switch (i2) {
            ...
            case 2:
                ...
                canvas.save();
                float[] matrixFloatArray = c.setMatrixFloatArray(instanceMatrixArray, 1.0f, 0.0f, 29.255177f, 0.0f, 1.0f, 24.542425f, 0.0f, 0.0f, 1.0f);
                ...
                float[] matrixFloatArray2 = c.setMatrixFloatArray(matrixFloatArray, 0.70710677f, 0.70710677f, -8.192555f, -0.70710677f, 0.70710677f, 9.440986f, 0.0f, 0.0f, 1.0f);
                instanceMatrix.reset();
