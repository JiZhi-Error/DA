...
public class icons_filled_down_arrow extends c {
    ...
    public int doCommand(int i2, Object... objArr) {
        switch (i2) {
            ...
            case 2:
                ...
                float[] matrixFloatArray = c.setMatrixFloatArray(instanceMatrixArray, -1.8369701E-16f, -1.0f, 24.0f, 1.0f, -1.8369701E-16f, 1.1021821E-15f, 0.0f, 0.0f, 1.0f);
                instanceMatrix.reset();
                instanceMatrix.setValues(matrixFloatArray);
                canvas.concat(instanceMatrix);
                canvas.save();
                Paint instancePaint4 = c.instancePaint(instancePaint3, looper);
                float[] matrixFloatArray2 = c.setMatrixFloatArray(matrixFloatArray, -0.70710677f, -0.70710677f, 16.170063f, 0.70710677f, -0.70710677f, 17.310062f, 0.0f, 0.0f, 1.0f);
                instanceMatrix.reset();
