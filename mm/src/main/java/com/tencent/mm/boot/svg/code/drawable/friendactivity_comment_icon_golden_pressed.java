...
public class friendactivity_comment_icon_golden_pressed extends c {
    ...
    public int doCommand(int i2, Object... objArr) {
        switch (i2) {
            ...
            case 2:
                ...
                instancePath2.moveTo(12.0f, 31.470589f);
                instancePath2.lineTo(12.0f, 46.0f);
                instancePath2.lineTo(66.0f, 46.0f);
                instancePath2.lineTo(66.0f, 0.0f);
                instancePath2.lineTo(12.0f, 0.0f);
                instancePath2.lineTo(12.0f, 14.529412f);
                instancePath2.lineTo(0.0f, 23.0f);
                instancePath2.lineTo(12.0f, 31.470589f);
                instancePath2.close();
                instancePath2.moveTo(27.0f, 29.0f);
                instancePath2.cubicTo(30.31371f, 29.0f, 33.0f, 26.31371f, 33.0f, 23.0f);
                instancePath2.cubicTo(33.0f, 19.68629f, 30.31371f, 17.0f, 27.0f, 17.0f);
                instancePath2.cubicTo(23.68629f, 17.0f, 21.0f, 19.68629f, 21.0f, 23.0f);
                instancePath2.cubicTo(21.0f, 26.31371f, 23.68629f, 29.0f, 27.0f, 29.0f);
                instancePath2.close();
                instancePath2.moveTo(51.0f, 29.0f);
                instancePath2.cubicTo(54.31371f, 29.0f, 57.0f, 26.31371f, 57.0f, 23.0f);
                instancePath2.cubicTo(57.0f, 19.68629f, 54.31371f, 17.0f, 51.0f, 17.0f);
                instancePath2.cubicTo(47.68629f, 17.0f, 45.0f, 19.68629f, 45.0f, 23.0f);
                instancePath2.cubicTo(45.0f, 26.31371f, 47.68629f, 29.0f, 51.0f, 29.0f);
                instancePath2.close();
