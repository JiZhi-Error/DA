...
public class icons_outlined_clip extends c {
    ...
    public int doCommand(int i2, Object... objArr) {
        switch (i2) {
            ...
            case 2:
                ...
                instancePath.lineTo(12.6f, 41.4f);
                instancePath.lineTo(41.4f, 41.4f);
                instancePath.lineTo(41.4f, 12.6f);
                instancePath.lineTo(12.6f, 12.6f);
                instancePath.close();
                instancePath.moveTo(9.0f, 12.6f);
                instancePath.lineTo(0.0f, 12.6f);
                instancePath.lineTo(0.0f, 9.0f);
                instancePath.lineTo(9.0f, 9.0f);
                instancePath.lineTo(9.0f, 0.0f);
                instancePath.lineTo(12.6f, 0.0f);
                instancePath.lineTo(12.6f, 9.0f);
                instancePath.lineTo(41.4f, 9.0f);
                instancePath.lineTo(42.0f, 9.0f);
                instancePath.cubicTo(43.656853f, 9.0f, 45.0f, 10.343145f, 45.0f, 12.0f);
                instancePath.lineTo(45.0f, 41.4f);
                instancePath.lineTo(54.0f, 41.4f);
                instancePath.lineTo(54.0f, 45.0f);
                instancePath.lineTo(45.0f, 45.0f);
                instancePath.lineTo(45.0f, 54.0f);
                instancePath.lineTo(41.4f, 54.0f);
                instancePath.lineTo(41.4f, 45.0f);
