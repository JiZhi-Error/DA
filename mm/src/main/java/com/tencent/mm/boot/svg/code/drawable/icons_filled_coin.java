...
public class icons_filled_coin extends c {
    ...
    public int doCommand(int i2, Object... objArr) {
        switch (i2) {
            ...
            case 2:
                ...
                instancePath.close();
                instancePath.moveTo(31.5f, 24.0f);
                instancePath.lineTo(25.5f, 24.0f);
                instancePath.lineTo(30.0f, 33.0f);
                instancePath.lineTo(25.5f, 33.0f);
                instancePath.lineTo(25.5f, 37.5f);
                instancePath.lineTo(33.75f, 37.5f);
                instancePath.lineTo(33.75f, 40.5f);
                instancePath.lineTo(25.5f, 40.5f);
                instancePath.lineTo(25.5f, 45.0f);
                instancePath.lineTo(33.75f, 45.0f);
                instancePath.lineTo(33.75f, 49.5f);
                instancePath.lineTo(38.25f, 49.5f);
                instancePath.lineTo(38.25f, 45.0f);
                instancePath.lineTo(46.5f, 45.0f);
                instancePath.lineTo(46.5f, 40.5f);
                instancePath.lineTo(38.25f, 40.5f);
                instancePath.lineTo(38.25f, 37.5f);
                instancePath.lineTo(46.5f, 37.5f);
                instancePath.lineTo(46.5f, 33.0f);
                instancePath.lineTo(42.0f, 33.0f);
                instancePath.lineTo(46.5f, 24.0f);
                instancePath.lineTo(40.5f, 24.0f);
