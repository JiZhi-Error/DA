...
class WXApiImplComm {
    ...
    private WXApiImplComm() {
        ...
        RuntimeException runtimeException = new RuntimeException(WXApiImplComm.class.getSimpleName() + " should not be instantiated");
        ...
        for (Signature signature : signatureArr) {
            if (signature != null) {
                ...
                if (lowerCase.equals(WX_APP_SIGNATURE)) {
                    Log.d(TAG, StateEvent.ActionValue.STAGE_PASS);
                    AppMethodBeat.o(3781);
                    return true;
                }
            }
