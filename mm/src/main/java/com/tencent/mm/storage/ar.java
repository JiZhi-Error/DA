...
public final class ar {
    public static String NSe = b.aKB();
    public static final String NSf = (MMApplicationContext.getContext().getFilesDir() + "/xlog");
    public static final String NSg = (MMApplicationContext.getContext().getFilesDir() + "/liteapp");
    public static final String NSh = WeChatHosts.domainString(R.string.e1r);
    ...
    public static boolean bjj(String str) {
    ...
    public static boolean bjk(String str) {
    ...
    private static final boolean gBJ() {
        ...
        Field[] declaredFields = ar.class.getDeclaredFields();
            ...
            if (Modifier.isStatic(field.getModifiers()) && ((field.getName().startsWith("USERINFO_") || field.getName().startsWith("NEW_BANDAGE_") || field.getName().startsWith("DYNAMIC_CONFIG_")) && field.getType().toString().equals("int"))) {
                try {
                    ...
                    if (sparseArray.get(i2, null) != null) {
                        Log.e("MicroMsg.ConstantsStorage", "%s and %s has same value(0x%05X)!!!", sparseArray.get(i2), field.getName(), Integer.valueOf(i2));
                        AppMethodBeat.o(133284);
                        return false;
                    }
                    sparseArray.put(i2, field.getName());
                } catch (IllegalArgumentException e2) {
                    Log.e("MicroMsg.ConstantsStorage", "exception:%s", Util.stackTraceToString(e2));
                } catch (IllegalAccessException e3) {
                    Log.e("MicroMsg.ConstantsStorage", "exception:%s", Util.stackTraceToString(e3));
                }
            }
        }
        if (sparseArray.size() > 515) {
            Log.e("MicroMsg.ConstantsStorage", "constants values size(%d) is over the limit(%d)!!!", Integer.valueOf(sparseArray.size()), 515);
            AppMethodBeat.o(133284);
            return false;
        }
        Log.i("MicroMsg.ConstantsStorage", "checkDuplicateUserInfo values size: %d", Integer.valueOf(sparseArray.size()));
        boolean gBK = gBK();
        AppMethodBeat.o(133284);
        return gBK;
    }
    ...
    private static final boolean gBK() {
        ...
        for (a aVar : values) {
            ...
            String bjl = bjl(aVar.name());
            if (Util.isNullOrNil(bjl)) {
                AppMethodBeat.o(133285);
                return false;
            } else if (arrayList.contains(bjl)) {
                Log.e("MicroMsg.ConstantsStorage", "BusinessInfoKey check error: redefinition of [%s] which already defined!", bjl);
                AppMethodBeat.o(133285);
                return false;
            } else {
                arrayList.add(bjl);
    ...
    private static final String bjl(String str) {
        ...
        if (split == null || split.length < 4) {
            ...
            Log.e("MicroMsg.ConstantsStorage", "BusinessInfoKey parse failed: key:%s split by '_'  fileds len too short : %d , at least 4", objArr);
            AppMethodBeat.o(133286);
            return null;
        }
        for (int i2 = 0; i2 < split.length; i2++) {
            if (split[i2] == null || split[i2].length() <= 0) {
                Log.e("MicroMsg.ConstantsStorage", "BusinessInfoKey parse failed: name:%s , [%s] too short ( <1 ) ", str, split[i2]);
                AppMethodBeat.o(133286);
                return null;
            }
        }
        ...
        if (length < 3) {
            ...
            Log.e("MicroMsg.ConstantsStorage", "BusinessInfoKey parse failed: name:%s split by '_'  fileds len too short : %d , at least 3", objArr2);
        }
        ...
        Log.e("MicroMsg.ConstantsStorage", "BusinessInfoKey parse failed: name[%s], invalid type:%s ", str, str2);
        AppMethodBeat.o(133286);
        return null;
    }
    ...
    public enum a {
        ...
        USERINFO_APP_BRAND_PLUGINCODE_CLEAR_TABLE_DONE_BOOLEAN,
        USERINFO_APP_BRAND_PLUGINCODE_CLEAR_CODECACHE_DONE_BOOLEAN,
        ...
        USERINFO_MY_FINDER_NICKNAME_STRING_SYNC,
        USERINFO_MY_FINDER_SIGNATURE_STRING_SYNC,
        USERINFO_MY_FINDER_AVATAR_STRING_SYNC,
        USERINFO_MY_FINDER_AUTH_INFO_STRING_SYNC,
        USERINFO_MY_FINDER_COVER_IMG_STRING_SYNC,
        ...
        USERINFO_MY_FINDER_ORIGINAL_FLAG2_INT_SYNC,
        USERINFO_MY_FINDER_ORIGINAL_REPOST_COUNT_INT_SYNC,
        USERINFO_MY_FINDER_ORIGINAL_APPLY_COUNT_INT_SYNC,
        USERINFO_MY_FINDER_ORIGINAL_PUNISH_INT_SYNC,
        USERINFO_MY_FINDER_ORIGINAL_PUNISH_YEAR_FLAG_INT_SYNC,
        USERINFO_MY_FINDER_ORIGINAL_ENTRANCE2_INT_SYNC,
        USERINFO_MY_FINDER_ORIGINAL_AUTHOR_STATEMENT_STRING_SYNC,
        USERINFO_MY_FINDER_ORIGINAL_NEED_CHECK_FLAG_INT_SYNC,
        USERINFO_MY_FINDER_POST_EDU_TITLE_STRING_SYNC,
        USERINFO_MY_FINDER_POST_EDU_DESC_STRING_SYNC,
        USERINFO_MY_FINDER_SHOP_BINDER_APPID_STRING_SYNC,
        USERINFO_MY_FINDER_SHOP_BINDER_PATH_STRING_SYNC,
        USERINFO_MY_FINDER_SHOP_APPID_STRING_SYNC,
        USERINFO_MY_FINDER_SHOP_PATH_STRING_SYNC,
        USERINFO_MY_FINDER_LIVE_FLAG_INT_SYNC,
        USERINFO_MY_FINDER_POST_ACTION_SHEET_LIST_STRING_SYNC,
        USERINFO_MY_FINDER_FIRST_HOT_TAB_PRELOAD_INT_SYNC,
        USERINFO_MY_FINDER_POST_NICK_NAME_MAX_LENGTH_INT_SYNC,
        USERINFO_FINDER_PREPARE_USER_FLAG_INT_SYNC,
        USERINFO_FINDER_LIVE_VERIFY_BOOLEAN_SYNC,
        USERINFO_FINDER_LIVE_LIST_REPEAT_BOOLEAN_SYNC,
        USERINFO_FINDER_LIVE_COVER_IMAGE_STRING_SYNC,
        USERINFO_FINDER_LIVE_ANCHOR_STATUS_FLAG_LONG_SYNC,
        USERINFO_FINDER_LIVE_SWITCH_FLAG_LONG_SYNC,
        USERINFO_FINDER_LIVE_LAST_LOTTERYID_STRING_SYNC,
        USERINFO_FINDER_LIVE_VISITOR_ROLE_INT_SYNC,
        USERINFO_FINDER_LIVE_ALIAS_LIST1_STRING_SYNC,
        USERINFO_FINDER_LIVE_ALIAS_MODIFY_TIME_LONG_SYNC,
        ...
        USERINFO_FINDER_USER_EXT_FLAG_INT_SYNC,
        ...
        USERINFO_FINDER_TAB_FRIEND_NAME_STRING,
        USERINFO_FINDER_TAB_MACHINE_NAME_STRING,
        USERINFO_FINDER_TAB_FOLLOW_NAME_STRING,
        ...
        USERINFO_FINDER_FANS_COUNT_INT_SYNC,
        USERINFO_FINDER_FANS_ADDCOUNT_INT_SYNC,
        ...
        USERINFO_FINDER_MSG_NORMAL_INT_SYNC,
        ...
        USERINFO_FINDER_FEED_BULLET_SUBTITLE_SWITCH_BOOLEAN,
        USERINFO_FINDER_FEED_BULLET_SUBTITLE_EXPT_HAS_SET_BOOLEAN_SYNC,
        ...
        USERINFO_FINDER_MEGA_VIDEO_BULLET_SWITCH_BOOLEAN,
        ...
        USERINFO_ACCOUNT_EXT_CONFIG_STRING_SYNC,
        ...
        USERINFO_STORAGE_PERMISSION_BANNER_CLOSED_FLAG_BOOLEAN_SYNC,
        ...
        USERINFO_TEXT_STATUS_LAST_SYNC_USERNAMEMAP_LONG_SYNC,
