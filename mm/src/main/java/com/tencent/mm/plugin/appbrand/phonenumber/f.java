...
public final class f {
    ...
    public final void y(kotlin.g.a.b<? super dul, x> bVar) {
        ...
        duk.dNI = this.appId;
        duk.dSf = this.dSf;
        ((c) e.M(c.class)).a("/cgi-bin/mmbiz-bin/wxaapp/sendverifycode", duk, dul.class).c(new a(bVar)).a(new b(bVar));
    ...
    static final class b<T> implements d.a<Object> {
        ...
        public final void cn(Object obj) {
            ...
            if (obj instanceof Exception) {
                Log.e("Luggage.FULL.CgiPhoneNumber", "CgiSendVerifyCodeWxaPhone " + ((Exception) obj).getMessage());
            }
            kotlin.g.a.b bVar = this.gWe;
            if (bVar != null) {
                bVar.invoke(null);
