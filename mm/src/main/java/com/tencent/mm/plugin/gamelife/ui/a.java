...
public final class a extends f {
    ...
    public final void a(b.C1424b bVar, int i2) {
        ...
        View view2 = bVar.aus;
        view2.setOnClickListener(new View$OnClickListenerC1423a(view2, this));
        if (ao.isDarkMode()) {
            ((ImageView) view.findViewById(R.id.wo)).setImageResource(R.raw.ic_filled_thumbs_dark);
        } else {
            ((ImageView) view.findViewById(R.id.wo)).setImageResource(R.raw.ic_filled_thumbs);
        }
        view.setBackgroundResource(R.drawable.qa);
        ((TextView) view.findViewById(R.id.bfx)).setText(R.string.dtm);
        ...
        if (NY > 0) {
            ...
            textView6.setText(NY > 99 ? "..." : String.valueOf(NY));
            ((TextView) view.findViewById(R.id.io7)).setBackgroundResource(v.aQ(view.getContext(), NY));
        }
        TextView textView7 = (TextView) view.findViewById(R.id.bmt);
        p.g(textView7, "itemView.descTv");
        textView7.setText(((c) g.af(c.class)).NZ(1));
        if (this.isFirst) {
            this.isFirst = false;
            Context context = MMApplicationContext.getContext();
            com.tencent.mm.plugin.gamelife.i.a aVar = com.tencent.mm.plugin.gamelife.i.a.ycs;
            com.tencent.mm.game.report.f.a(context, 21, 0, 0, 1, (int) com.tencent.mm.plugin.gamelife.i.a.dXm(), null);
            Context context2 = MMApplicationContext.getContext();
            com.tencent.mm.plugin.gamelife.i.a aVar2 = com.tencent.mm.plugin.gamelife.i.a.ycs;
            com.tencent.mm.game.report.f.a(context2, 21, 2101, 1, 1, (int) com.tencent.mm.plugin.gamelife.i.a.dXm(), k(Integer.valueOf(NY)));
        }
        AppMethodBeat.o(241432);
    }

    /* access modifiers changed from: package-private */
    @l(hxD = {1, 1, 16}, hxE = {"\u0000\u0014\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\b\u0003\u0010\u0000\u001a\u00020\u00012\u000e\u0010\u0002\u001a\n \u0004*\u0004\u0018\u00010\u00030\u0003H\n¢\u0006\u0002\b\u0005¨\u0006\u0006"}, hxF = {"<anonymous>", "", "view", "Landroid/view/View;", "kotlin.jvm.PlatformType", "onClick", "com/tencent/mm/plugin/gamelife/ui/GameInteractionNotifyMsgViewProvider$onBindViewHolder$1$1"})
    /* renamed from: com.tencent.mm.plugin.gamelife.ui.a$a  reason: collision with other inner class name */
    public static final class View$OnClickListenerC1423a implements View.OnClickListener {
        final /* synthetic */ View tCl;
        final /* synthetic */ a ycz;

        View$OnClickListenerC1423a(View view, a aVar) {
            this.tCl = view;
            this.ycz = aVar;
        }
        ...
        public final void onClick(View view) {
            ...
            bVar.bm(view);
            com.tencent.mm.hellhoundlib.a.a.b("com/tencent/mm/plugin/gamelife/ui/GameInteractionNotifyMsgViewProvider$onBindViewHolder$$inlined$apply$lambda$1", "android/view/View$OnClickListener", "onClick", "(Landroid/view/View;)V", this, bVar.axR());
            ...
            Context context = MMApplicationContext.getContext();
            com.tencent.mm.plugin.gamelife.i.a aVar = com.tencent.mm.plugin.gamelife.i.a.ycs;
            com.tencent.mm.game.report.f.a(context, 21, 2101, 1, 6, (int) com.tencent.mm.plugin.gamelife.i.a.dXm(), a.k(num));
