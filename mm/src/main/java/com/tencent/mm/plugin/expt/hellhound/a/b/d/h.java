...
public final class h implements b {
    ...
    public static final a sHs = new a((byte) 0);
    ...
    public h() {
        ...
        try {
            ...
            Log.printErrStackTrace("HABBYGE-MALI.TopicParamsCatcher", e2, "reflect crash: %s", e2.getMessage());
            AppMethodBeat.o(221096);
        }
    }

    @l(hxD = {1, 1, 16}, hxE = {"\u0000$\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\u000e\n\u0002\b\u0007\n\u0002\u0018\u0002\n\u0002\b\u0005\n\u0002\u0018\u0002\n\u0002\b\n\b\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002R\u000e\u0010\u0003\u001a\u00020\u0004XT¢\u0006\u0002\n\u0000R\u000e\u0010\u0005\u001a\u00020\u0004XT¢\u0006\u0002\n\u0000R\u000e\u0010\u0006\u001a\u00020\u0004XT¢\u0006\u0002\n\u0000R\u000e\u0010\u0007\u001a\u00020\u0004XT¢\u0006\u0002\n\u0000R\u000e\u0010\b\u001a\u00020\u0004XT¢\u0006\u0002\n\u0000R\u000e\u0010\t\u001a\u00020\u0004XT¢\u0006\u0002\n\u0000R\u000e\u0010\n\u001a\u00020\u0004XT¢\u0006\u0002\n\u0000R\u0010\u0010\u000b\u001a\u0004\u0018\u00010\fX\u000e¢\u0006\u0002\n\u0000R\u0010\u0010\r\u001a\u0004\u0018\u00010\fX\u000e¢\u0006\u0002\n\u0000R\u000e\u0010\u000e\u001a\u00020\u0004XT¢\u0006\u0002\n\u0000R\u000e\u0010\u000f\u001a\u00020\u0004XT¢\u0006\u0002\n\u0000R\u0010\u0010\u0010\u001a\u0004\u0018\u00010\fX\u000e¢\u0006\u0002\n\u0000R\u000e\u0010\u0011\u001a\u00020\u0012X.¢\u0006\u0002\n\u0000R\u000e\u0010\u0013\u001a\u00020\u0004XT¢\u0006\u0002\n\u0000R\u0010\u0010\u0014\u001a\u0004\u0018\u00010\u0012X\u000e¢\u0006\u0002\n\u0000R\u000e\u0010\u0015\u001a\u00020\u0004XT¢\u0006\u0002\n\u0000R\u0010\u0010\u0016\u001a\u0004\u0018\u00010\u0012X\u000e¢\u0006\u0002\n\u0000R\u0010\u0010\u0017\u001a\u0004\u0018\u00010\u0012X\u000e¢\u0006\u0002\n\u0000R\u000e\u0010\u0018\u001a\u00020\u0004XT¢\u0006\u0002\n\u0000R\u000e\u0010\u0019\u001a\u00020\fX.¢\u0006\u0002\n\u0000R\u000e\u0010\u001a\u001a\u00020\u0004XT¢\u0006\u0002\n\u0000R\u000e\u0010\u001b\u001a\u00020\u0004XT¢\u0006\u0002\n\u0000¨\u0006\u001c"}, hxF = {"Lcom/tencent/mm/plugin/expt/hellhound/ext/finder/statistics/TopicParamsCatcher$Companion;", "", "()V", "BaseFinderFeed_Name", "", "FinderItem_Name", "FinderMediaBannerAdapter_Name", "FinderObject_Name", "TAG", "WxRecyclerAdapter_Name", "data_Field_Name", "data_field", "Ljava/lang/reflect/Field;", "feedObject_Field", "feedObject_Field_Name", "feed_Field_Name", "feed_field", "getFinderObject_Method", "Ljava/lang/reflect/Method;", "getFinderObject_Method_Name", "getId_Method", "getId_Method_Name", "getNickName_Method", "getUserName_Method", "nickName_Method_Name", "sessionBuffer_Field", "sessionBuffer_Field_Name", "userName_Method_Name", "plugin-expt_release"})
            ...
            if (!(recyclerView == null || (adapter = recyclerView.getAdapter()) == null)) {
                if (adapter instanceof WxRecyclerAdapter) {
                    try {
                        ...
                        Log.printErrStackTrace("HABBYGE-MALI.TopicParamsCatcher", e2, "_getFeedId, e2, crash: " + e2.getMessage(), new Object[0]);
                        AppMethodBeat.o(221091);
                        return null;
                    }
                    ...
                    try {
                        ...
                        Log.printErrStackTrace("HABBYGE-MALI.TopicParamsCatcher", e3, "_getFeedId, e1, crash: " + e3.getMessage(), new Object[0]);
                        AppMethodBeat.o(221091);
                        return null;
                    }
                } else {
            ...
            if (!(recyclerView == null || (adapter = recyclerView.getAdapter()) == null)) {
                if (adapter instanceof WxRecyclerAdapter) {
                    try {
                        ...
                        Log.printErrStackTrace("HABBYGE-MALI.TopicParamsCatcher", e2, "getFeedUserName e1: " + e2.getMessage(), new Object[0]);
                        AppMethodBeat.o(221092);
                        return null;
                    }
                } else if (adapter instanceof com.tencent.mm.ui.base.a.a) {
                    try {
                        ...
                        Log.printErrStackTrace("HABBYGE-MALI.TopicParamsCatcher", e3, "getFeedUserName e2: " + e3.getMessage(), new Object[0]);
                        AppMethodBeat.o(221092);
                        return null;
                    }
                } else {
            ...
            if (!(recyclerView == null || (adapter = recyclerView.getAdapter()) == null)) {
                if (adapter instanceof WxRecyclerAdapter) {
                    try {
                        ...
                        Log.printErrStackTrace("HABBYGE-MALI.TopicParamsCatcher", e2, "getFeedNickName e1: " + e2.getMessage(), new Object[0]);
                        AppMethodBeat.o(221093);
                        return null;
                    }
                } else if (adapter instanceof com.tencent.mm.ui.base.a.a) {
                    try {
                        ...
                        Log.printErrStackTrace("HABBYGE-MALI.TopicParamsCatcher", e3, "getFeedNickName e2: " + e3.getMessage(), new Object[0]);
                        AppMethodBeat.o(221093);
                        return null;
                    }
                } else {
    ...
    public final void setRecyclerView(android.support.v7.widget.RecyclerView r3) {
        /*
            r2 = this;
            r1 = 221094(0x35fa6, float:3.09819E-40)
        ...
        L_0x0027:
            ...
            goto L_0x001a
        */
        throw new UnsupportedOperationException("Method not decompiled: com.tencent.mm.plugin.expt.hellhound.a.b.d.h.setRecyclerView(android.support.v7.widget.RecyclerView):void");
    }
                ...
                if (adapter instanceof WxRecyclerAdapter) {
                    try {
                        ...
                        try {
                            ...
                            Log.printErrStackTrace("HABBYGE-MALI.TopicParamsCatcher", e3, "getSessionBuffer crash: " + e3.getMessage(), new Object[0]);
                            AppMethodBeat.o(221095);
                            return null;
                        }
                    }
