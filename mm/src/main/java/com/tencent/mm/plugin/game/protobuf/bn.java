...
public final class bn extends dop {
    public String keh;
            ...
            switch (intValue) {
                case 1:
                    ...
                    for (int i3 = 0; i3 < size; i3++) {
                        ...
                        bnVar.BaseRequest = jrVar;
                    }
                    AppMethodBeat.o(41766);
                    return 0;
                case 2:
                    bnVar.xLl = aVar3.UbS.readString();
                    AppMethodBeat.o(41766);
                    return 0;
                case 3:
                    bnVar.xLF.add(aVar3.UbS.readString());
                    AppMethodBeat.o(41766);
                    return 0;
                case 4:
                    bnVar.keh = aVar3.UbS.readString();
                    AppMethodBeat.o(41766);
                    return 0;
                case 5:
                    ...
                    return 0;
                case 6:
                    bnVar.xLH = aVar3.UbS.zi();
                    AppMethodBeat.o(41766);
                    return 0;
                case 7:
                    bnVar.xLI = aVar3.UbS.yZ();
                    AppMethodBeat.o(41766);
                    return 0;
                case 8:
                    bnVar.xLm = aVar3.UbS.zi();
                    AppMethodBeat.o(41766);
                    return 0;
                default:
                    AppMethodBeat.o(41766);
