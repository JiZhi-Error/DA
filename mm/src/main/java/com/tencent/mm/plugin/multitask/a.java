...
@l(hxD = {1, 1, 16}, hxE = {"\u0000$\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u000e\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\u0018\u00002\u0012\u0012\u0006\u0012\u0004\u0018\u00010\u0002\u0012\u0006\u0012\u0004\u0018\u00010\u00020\u0001B\u0005¢\u0006\u0002\u0010\u0003J%\u0010\u0006\u001a\u00020\u00072\b\u0010\b\u001a\u0004\u0018\u00010\u00022\u0010\u0010\t\u001a\f\u0012\u0006\u0012\u0004\u0018\u00010\u0002\u0018\u00010\nH\u0002R\u000e\u0010\u0004\u001a\u00020\u0005XD¢\u0006\u0002\n\u0000¨\u0006\u000b"}, hxF = {"Lcom/tencent/mm/plugin/multitask/AddTaskInfoTask;", "Lcom/tencent/mm/ipcinvoker/IPCAsyncInvokeTask;", "Landroid/os/Bundle;", "()V", "TAG", "", "invoke", "", "data", "callback", "Lcom/tencent/mm/ipcinvoker/IPCInvokeCallback;", "plugin-multitask_release"})
public final class a implements b<Bundle, Bundle> {
    private final String TAG = "MicroMsg.MultiTask.AddTaskInfoTask";
    ...
    public final /* synthetic */ void invoke(Bundle bundle, d<Bundle> dVar) {
        ...
        if (bundle2 != null) {
            ...
            if (!(string == null || byteArray == null)) {
                ...
                byte[] byteArray2 = bundle2.getByteArray("reportdata");
                crt crt = new crt();
                if (byteArray2 != null) {
                    try {
                        crt.parseFrom(byteArray2);
                    } catch (Exception e3) {
                        x xVar = x.SXb;
                    }
                }
                ((PluginMultiTask) g.ah(PluginMultiTask.class)).addTaskInfo(string, i2, cru, bundle2.getByteArray("data"), crt);
            }
