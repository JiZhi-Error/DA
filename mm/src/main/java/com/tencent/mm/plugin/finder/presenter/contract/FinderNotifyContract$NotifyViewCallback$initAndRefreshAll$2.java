...
public final class FinderNotifyContract$NotifyViewCallback$initAndRefreshAll$2 extends q implements a<x> {
    final /* synthetic */ FinderNotifyContract.NotifyViewCallback uZd;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public FinderNotifyContract$NotifyViewCallback$initAndRefreshAll$2(FinderNotifyContract.NotifyViewCallback notifyViewCallback) {
        super(0);
