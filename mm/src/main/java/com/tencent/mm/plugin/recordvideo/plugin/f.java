...
public final class f implements View.OnClickListener, t {
    ...
    public final void onClick(View view2) {
        ...
        b bVar = new b();
        bVar.bm(view2);
        com.tencent.mm.hellhoundlib.a.a.b("com/tencent/mm/plugin/recordvideo/plugin/EditFinishPlugin", "android/view/View$OnClickListener", "onClick", "(Landroid/view/View;)V", this, bVar.axR());
    ...
    public final void a(Integer num, Integer num2, String str, Integer num3) {
        ...
        if (!(num2 == null || num2.intValue() == 0 || !(view2 instanceof TextView))) {
            ((TextView) view2).setTextColor(android.support.v4.content.b.n(((TextView) view2).getContext(), num2.intValue()));
        }
        String str2 = str;
        if (!(str2 == null || str2.length() == 0) && (view2 instanceof TextView)) {
