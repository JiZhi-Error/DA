...
public final class aq extends am {
    ...
    public final void a(h hVar, BaseFinderFeed baseFinderFeed, int i2, int i3, boolean z, List<Object> list) {
        ...
        ImageView imageView = (ImageView) hVar.Mn(R.id.fc2);
        if (baseFinderFeed.feedObject.getMediaList().size() > 1) {
            p.g(imageView, "mediaIcon");
            imageView.setImageDrawable(ar.m(imageView.getContext(), R.raw.icons_filled_album, a.n(imageView.getContext(), R.color.am)));
        ...
        k kVar = new k((cjl) j.ks(baseFinderFeed.feedObject.getMediaList()), x.THUMB_IMAGE, null, null, 12);
        m mVar2 = m.uJa;
        b<o, Bitmap> a2 = djY.a(kVar, m.a(m.a.TIMELINE));
        c cVar = c.vCb;
        if (c.dtK().value().intValue() > 0) {
            dVar = new d(null, new g(imageView2), 1);
        } else {
            dVar = null;
        }
        com.tencent.mm.loader.b<o, Bitmap> a3 = a2.a(dVar);
