...
public final class b extends RecyclerView.h {
    ...
    public final void a(Rect rect, View view, RecyclerView recyclerView, RecyclerView.s sVar) {
        ...
        int aH = a.aH(recyclerView.getContext(), R.dimen.f3062g);
        rect.set(aH, aH, aH, aH);
