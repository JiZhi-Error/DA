...
public final class a extends View {
    ...
    public interface AbstractC2006a {
        void a(int i2, MotionEvent motionEvent);
    }

    public a(Context context, int i2, int i3, int i4, int i5, AbstractC2006a aVar) {
        super(context);
    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (this.JIL != null) {
            this.JIL.a(this.mType, motionEvent);
        }
