...
public final class c implements Html.TagHandler {
    ...
    private Stack<com.tencent.mm.plugin.wenote.model.nativenote.spans.a> qQc = new Stack<>();
    ...
    public final void handleTag(boolean z, String str, Editable editable, XMLReader xMLReader) {
        ...
        if (!z) {
            if (str.equalsIgnoreCase("wx-ul")) {
                ...
                AbstractC2005c cVar = (AbstractC2005c) a(editable, (Class<? extends Object>) AbstractC2005c.class);
                if (cVar != null) {
                    ...
                    if (!cVar.qQk) {
                        editable.setSpan(new k(((e) cVar).oD, com.tencent.mm.plugin.wenote.model.nativenote.manager.b.cDE(), spanStart == length, false, false), spanStart, length, 33);
                    }
                    editable.removeSpan(cVar);
                }
            } else if (str.equalsIgnoreCase("wx-li")) {
                AbstractC2005c cVar2 = (AbstractC2005c) a(editable, (Class<? extends Object>) AbstractC2005c.class);
                if (cVar2 != null) {
                    if (editable.length() == 0 || editable.charAt(editable.length() - 1) != '\n') {
                        editable.append('\n');
                    }
                    ...
                    if (!cVar2.qQk) {
                        int cDE = com.tencent.mm.plugin.wenote.model.nativenote.manager.b.cDE();
                        if (cVar2 instanceof d) {
                            dVar = new m(1, cDE, spanStart2 == length2, false, false);
                        } else {
                            if (spanStart2 != length2) {
                                z2 = false;
                            }
                            dVar = new com.tencent.mm.plugin.wenote.model.nativenote.spans.d(cDE, z2, false, false);
                        }
                ...
                if (a2 != null) {
                    ...
                    if (spanStart3 != length3) {
                        ...
                        if (bVar.mSize > 0) {
                            editable.setSpan(new AbsoluteSizeSpan(com.tencent.mm.plugin.wenote.model.nativenote.manager.b.Fz(bVar.mSize)), spanStart3, length3, 33);
                        }
            ...
            this.qQc.push(new com.tencent.mm.plugin.wenote.model.nativenote.spans.a(q.NOTETODO, 1, 1));
            ...
            if (!this.qQc.isEmpty()) {
                com.tencent.mm.plugin.wenote.model.nativenote.spans.a peek = this.qQc.peek();
                q qVar = peek.JIU;
                int i4 = peek.qSZ;
                if (qVar.cEx()) {
                    fVar = new d(i4);
    ...
    private void a(boolean z, q qVar) {
        com.tencent.mm.plugin.wenote.model.nativenote.spans.a peek;
        ...
        if (peek == null) {
            this.qQc.push(new com.tencent.mm.plugin.wenote.model.nativenote.spans.a(qVar, 1, 1));
            AppMethodBeat.o(30395);
        } else if (peek.JIU == qVar) {
            peek.qSZ++;
            peek.qTa++;
            AppMethodBeat.o(30395);
        } else {
            this.qQc.push(new com.tencent.mm.plugin.wenote.model.nativenote.spans.a(qVar, peek.qSZ + 1, 1));
            AppMethodBeat.o(30395);
        }
    }
    ...
    private void lg(boolean z) {
        ...
        while (!this.qQc.isEmpty()) {
            com.tencent.mm.plugin.wenote.model.nativenote.spans.a peek = this.qQc.peek();
            q qVar = peek.JIU;
            if ((!z || !qVar.cEx()) && ((z || !qVar.cEw()) && (z || !qVar.cEy()))) {
                this.qQc.pop();
            } else {
                int i2 = peek.qTa;
                if (i2 > 1) {
    ...
    /* renamed from: com.tencent.mm.plugin.wenote.model.nativenote.a.c$c  reason: collision with other inner class name */
    static abstract class AbstractC2005c {
        int qQj;
        boolean qQk = false;

        AbstractC2005c(int i2) {
            this.qQj = i2;
        }
    }

    static class f extends AbstractC2005c {
        f(int i2) {
            super(i2);
        }
    }

    static class d extends AbstractC2005c {
        d(int i2) {
            super(i2);
        }
    }

    static class e extends AbstractC2005c {
        boolean oD = false;
