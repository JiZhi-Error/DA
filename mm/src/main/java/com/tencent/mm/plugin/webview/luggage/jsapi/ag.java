...
public class ag extends bs<g> {
    ...
    public final void a(final Context context, String str, final br.a aVar) {
        ...
        final String optString = Zc.optString("appID");
        final String optString2 = Zc.optString("schemeUrl");
        final String optString3 = Zc.optString("parameter");
        final String optString4 = Zc.optString(AssistantStore.DownloadInfos.DownloadInfoColumns.PACKAGENAME);
        final String optString5 = Zc.optString("signature");
        int optInt = Zc.optInt("alertType");
        final String optString6 = Zc.optString(IssueStorage.COLUMN_EXT_INFO);
        Log.i("MicroMsg.JsApiLaunchApplication", "doLaunchApplication, appid : %s, scheme : %s, extinfo:[%s], parameter : %s, pkg:%s, signature:%s", optString, optString2, optString6, optString3, optString4, optString5);
        if (!Util.isNullOrNil(optString) || !Util.isNullOrNil(optString2) || !Util.isNullOrNil(optString4)) {
            ...
            String optString8 = Zc.optString("currentUrl");
            ...
            Log.i("MicroMsg.JsApiLaunchApplication", "run cgi to check(appId : %s, toAppId : %s, scene : %s, url : %s, schemeUrl : %s, alertType : %s)", optString7, optString, Integer.valueOf(cea.scene), cea.url, cea.MjE, Integer.valueOf(cea.qwp));
            aa.a(aXF, new aa.a() {
                /* class com.tencent.mm.plugin.webview.luggage.jsapi.ag.AnonymousClass1 */

                @Override // com.tencent.mm.ak.aa.a
                public final int a(final int i2, final int i3, final String str, final d dVar, q qVar) {
                    AppMethodBeat.i(78576);
                    p.post(new Runnable() {
                        /* class com.tencent.mm.plugin.webview.luggage.jsapi.ag.AnonymousClass1.AnonymousClass1 */
                        ...
                        public final void run() {
                            ...
                            Log.d("MicroMsg.JsApiLaunchApplication", "on RunCgi callback errType:%d errCode:%d msg:%s", Integer.valueOf(i2), Integer.valueOf(i3), str);
                            if (i2 == 0 && i3 == 0) {
                                ceb ceb = (ceb) dVar.iLL.iLR;
                                switch (ceb.dIZ) {
                                    case 0:
                                        am amVar = new am(new am.a() {
                                            /* class com.tencent.mm.plugin.webview.luggage.jsapi.ag.AnonymousClass1.AnonymousClass1.AnonymousClass1 */
                                        ...
                                        if (!Util.isNullOrNil(optString2)) {
                                            ...
                                            if (queryIntentActivities != null && !queryIntentActivities.isEmpty()) {
                                                if (!TextUtils.isEmpty(intent.getPackage()) || queryIntentActivities.size() != 1) {
                                                    ...
                                                    str2 = h.b(queryIntentActivities.get(0));
                                                }
                                                if (!Util.nullAsNil(MMApplicationContext.getPackageName()).equals(str2)) {
                                                    amVar.hj(h.a(context, intent, (String) null, ceb.xGz, amVar, bundle));
                                            ...
                                            if (messageDigest == null || !messageDigest.equalsIgnoreCase(optString5)) {
                                                ...
                                                try {
                                                    ...
                                                    if (launchIntentForPackage != null) {
                                                        ...
                                                        amVar.hj(h.a(context, launchIntentForPackage, null, amVar, bundle));
                                                        AppMethodBeat.o(78575);
                                                        return;
                                                    }
                                                } catch (Exception e2) {
                                        ...
                                        if (!z2 && !Util.isNullOrNil(optString) && !Util.isNullOrNil(optString3)) {
                                            ...
                                            Log.i("MicroMsg.JsApiLaunchApplication", "launchApplication by opensdk failed, try to launch by scheme(%s).", str3);
                                            ...
                                            if (queryIntentActivities2 != null && !queryIntentActivities2.isEmpty()) {
                                                if (!TextUtils.isEmpty(intent2.getPackage()) || queryIntentActivities2.size() != 1) {
                                                    ...
                                                    str = h.b(queryIntentActivities2.get(0));
                                                }
                                                if (!Util.nullAsNil(MMApplicationContext.getPackageName()).equals(str)) {
                                                    amVar.reset();
                                                    z = h.a(context, intent2, null, amVar, bundle);
                                                    amVar.hj(z);
                                                    AppMethodBeat.o(78575);
                                                    return;
                                                }
                                    ...
                                    case 1:
                                    default:
                                        aVar.i("check fail", null);
                                        AppMethodBeat.o(78575);
                                        return;
                                    case 2:
                                        aVar.i("check fail forbidden scene", null);
                                        AppMethodBeat.o(78575);
                                        return;
                                }
                            } else {
