...
public final class d {
    ...
    public static void fpW() {
        ...
        h.INSTANCE.n(oIi, BXN, 1);
        AppMethodBeat.o(119422);
    }

    public static void Kr(long j2) {
        AppMethodBeat.i(119423);
        Log.d(TAG, "reportZipTime ".concat(String.valueOf(j2)));
        h.INSTANCE.n(oIi, 13, 1);
        h.INSTANCE.n(oIi, 14, j2);
