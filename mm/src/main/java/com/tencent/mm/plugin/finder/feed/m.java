...
public final class m {
    ...
    public static final class a extends v.a {
        ...
        /* renamed from: com.tencent.mm.plugin.finder.feed.m$a$a  reason: collision with other inner class name */
        static final class C1154a extends q implements kotlin.g.a.b<Integer, bo> {
            final /* synthetic */ a tOe;
            ...
            public final /* synthetic */ bo invoke(Integer num) {
                ...
                if (intValue >= 0) {
                    BaseFinderFeedLoader baseFinderFeedLoader = this.tOe.tFM;
                    if (intValue < ((baseFinderFeedLoader == null || (dataListJustForAdapter = baseFinderFeedLoader.getDataListJustForAdapter()) == null) ? 0 : dataListJustForAdapter.size())) {
                        BaseFinderFeedLoader baseFinderFeedLoader2 = this.tOe.tFM;
        ...
        static final class b extends q implements kotlin.g.a.m<Integer, Integer, LinkedList<bo>> {
            final /* synthetic */ a tOe;
            ...
            public final /* synthetic */ LinkedList<bo> invoke(Integer num, Integer num2) {
                ...
                if (intValue >= 0) {
                    BaseFinderFeedLoader baseFinderFeedLoader2 = this.tOe.tFM;
                    if (!(intValue2 >= ((baseFinderFeedLoader2 == null || (dataListJustForAdapter2 = baseFinderFeedLoader2.getDataListJustForAdapter()) == null) ? 0 : dataListJustForAdapter2.size()) || (baseFinderFeedLoader = this.tOe.tFM) == null || (dataListJustForAdapter = baseFinderFeedLoader.getDataListJustForAdapter()) == null || (a2 = j.a((List) dataListJustForAdapter, new kotlin.k.f(intValue, intValue2))) == null)) {
        ...
        /* JADX INFO: super call moved to the top of the method (can break code semantics) */
        public a(MMActivity mMActivity, int i2, boolean z) {
            super(mMActivity);
        ...
        public final void requestRefresh() {
            ...
            if (!this.uW || (baseFinderFeedLoader = this.tFM) == null) {
        ...
        public final void a(BaseFinderFeedLoader baseFinderFeedLoader, v.b bVar) {
            ...
            this.tLy.a(this.scene, this.tCE, new C1154a(this));
        ...
        public final void dcd() {
            ...
            if (bVar != null) {
                recyclerView = bVar.tLS.getRecyclerView();
            } else {
                recyclerView = null;
            }
            k.b(recyclerView, s.p.LIVE_AUDIENCE_EXPLORE_FEED_CARD_LIVING_AVATAR, "40", com.tencent.mm.plugin.finder.report.live.c.EVENT_ON_REFRESH);
