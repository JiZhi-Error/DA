...
public final class c extends f {
    ...
    static final class a extends q implements b<f.d, x> {
        ...
        public final /* synthetic */ x invoke(f.d dVar) {
            ...
            this.uUW.uVb.a(this.uUW.uVf, this.uUV, "performChangeEnterTargetTab");
            x xVar = x.SXb;
    ...
    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public c(FinderStreamTabPreloadCore finderStreamTabPreloadCore) {
        super(1, finderStreamTabPreloadCore);
