...
public class al extends ae {
    ...
    static final class a extends kotlin.g.b.q implements kotlin.g.a.a<Integer> {
        public static final a tEi = new a();
