...
public final class a extends c<dqr> {
    ...
    public a(String str) {
        ...
        aVar.c(dqq);
        aVar.d(new dqr());
        aVar.MB("/cgi-bin/micromsg-bin/subappforcepush");
        aVar.sG(3743);
        aVar.sI(0);
        aVar.sJ(0);
        c(aVar.aXF());
    ...
    public final /* synthetic */ void a(int i2, int i3, String str, dqr dqr, q qVar) {
        ...
        Log.i(this.TAG, "CgiAcceptForceNotify errType:%d, errCode:%d, errMsg:%s", Integer.valueOf(i2), Integer.valueOf(i3), str);
        if (!(i2 == 0 && i3 == 0)) {
