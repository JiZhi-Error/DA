...
public final class FinderMsgContract$MsgPresenter$sortMentionList$comparator$1<T> implements Comparator<a> {
    public static final FinderMsgContract$MsgPresenter$sortMentionList$comparator$1 uYy = new FinderMsgContract$MsgPresenter$sortMentionList$comparator$1();
    ...
    FinderMsgContract$MsgPresenter$sortMentionList$comparator$1() {
    }
