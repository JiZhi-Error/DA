...
public final class d extends a {
    ...
    public d(Context context, FrameLayout frameLayout, Bitmap bitmap, int i2, int i3, int i4, int i5, int i6) {
    ...
    public final Rect eYz() {
        ...
        while (true) {
            ...
            a(rect, (int) h.al((float) (al / 2), (float) (this.DAR - (al / 2))), (int) h.al((float) (this.DAS / 2), (float) (this.DAS + (this.mMaxSize * 4))), al);
            int i3 = 0;
            while (true) {
                if (i3 >= this.DAW.size()) {
                    z = false;
