...
public final class h {
    ...
    public static final class a extends v.a {
        ...
        static final class C1147a extends q implements kotlin.g.a.b<Integer, bo> {
            final /* synthetic */ a tNJ;
            ...
            public final /* synthetic */ bo invoke(Integer num) {
                ...
                if (intValue >= 0) {
                    BaseFinderFeedLoader baseFinderFeedLoader = this.tNJ.tFM;
                    if (intValue < ((baseFinderFeedLoader == null || (dataListJustForAdapter = baseFinderFeedLoader.getDataListJustForAdapter()) == null) ? 0 : dataListJustForAdapter.size())) {
                        BaseFinderFeedLoader baseFinderFeedLoader2 = this.tNJ.tFM;
        ...
        static final class b extends q implements m<Integer, Integer, LinkedList<bo>> {
            ...
            public final /* synthetic */ LinkedList<bo> invoke(Integer num, Integer num2) {
                ...
                if (intValue >= 0) {
                    BaseFinderFeedLoader baseFinderFeedLoader2 = this.tNJ.tFM;
                    if (!(intValue2 >= ((baseFinderFeedLoader2 == null || (dataListJustForAdapter2 = baseFinderFeedLoader2.getDataListJustForAdapter()) == null) ? 0 : dataListJustForAdapter2.size()) || (baseFinderFeedLoader = this.tNJ.tFM) == null || (dataListJustForAdapter = baseFinderFeedLoader.getDataListJustForAdapter()) == null || (a2 = j.a((List) dataListJustForAdapter, new kotlin.k.f(intValue, intValue2))) == null)) {
        ...
        public final void a(BaseFinderFeedLoader baseFinderFeedLoader, v.b bVar) {
            ...
            this.tLy.a(this.scene, this.tCE, new C1147a(this));
        ...
        public final void dcd() {
            ...
            k.b(recyclerView, s.p.LIVE_AUDIENCE_EXPLORE_FEED_CARD_LIVING_AVATAR, "21", com.tencent.mm.plugin.finder.report.live.c.EVENT_ON_REFRESH);
