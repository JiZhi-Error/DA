...
public final class FinderMegaVideoLikeTLUIC extends BaseMegaVideoTLUIC {
    ...
    @l(hxD = {1, 1, 16}, hxE = {"\u0000\u0012\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\u000e\n\u0000\b\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002R\u000e\u0010\u0003\u001a\u00020\u0004XT¢\u0006\u0002\n\u0000¨\u0006\u0005"}, hxF = {"Lcom/tencent/mm/plugin/finder/megavideo/uic/FinderMegaVideoLikeTLUIC$Companion;", "", "()V", "TAG", "", "plugin-finder_release"})
    ...
    public FinderMegaVideoLikeTLUIC(AppCompatActivity appCompatActivity) {
    ...
    public static final /* synthetic */ h.b a(FinderMegaVideoLikeTLUIC finderMegaVideoLikeTLUIC) {
        AppMethodBeat.i(248633);
        h.b bVar = finderMegaVideoLikeTLUIC.uLW;
        if (bVar == null) {
            p.btv("viewCallback");
        }
    ...
    public final void onCreate(Bundle bundle) {
        ...
        FinderLikeMegaVideoLoader finderLikeMegaVideoLoader = new FinderLikeMegaVideoLoader(((FinderReporterUIC) com.tencent.mm.ui.component.a.b(getActivity()).get(FinderReporterUIC.class)).dIx());
        finderLikeMegaVideoLoader.initFromCache(getIntent());
        finderLikeMegaVideoLoader.setInitDone(new b(finderLikeMegaVideoLoader, this));
        h.a aVar3 = this.uMy;
        if (aVar3 == null) {
            p.btv("presenter");
        }
        FinderLikeMegaVideoLoader finderLikeMegaVideoLoader2 = finderLikeMegaVideoLoader;
        h.b bVar = this.uLW;
        if (bVar == null) {
            p.btv("viewCallback");
        }
        aVar3.a(finderLikeMegaVideoLoader2, bVar);
        AppMethodBeat.o(248628);
    }

    @l(hxD = {1, 1, 16}, hxE = {"\u0000\u0017\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0010\b\n\u0000*\u0001\u0000\b\n\u0018\u00002\u00020\u0001J\u0010\u0010\u0002\u001a\u00020\u00032\u0006\u0010\u0004\u001a\u00020\u0005H\u0016¨\u0006\u0006¸\u0006\u0000"}, hxF = {"com/tencent/mm/plugin/finder/megavideo/uic/FinderMegaVideoLikeTLUIC$onCreate$feedLoader$1$1", "Lcom/tencent/mm/plugin/finder/feed/model/internal/IInitDone;", "call", "", "incrementCount", "", "plugin-finder_release"})
    public static final class b implements com.tencent.mm.plugin.finder.feed.model.internal.h {
        final /* synthetic */ FinderLikeMegaVideoLoader uNb;
        final /* synthetic */ FinderMegaVideoLikeTLUIC uNc;

        b(FinderLikeMegaVideoLoader finderLikeMegaVideoLoader, FinderMegaVideoLikeTLUIC finderMegaVideoLikeTLUIC) {
            this.uNb = finderLikeMegaVideoLoader;
            this.uNc = finderMegaVideoLikeTLUIC;
        }

        @Override // com.tencent.mm.plugin.finder.feed.model.internal.h
        public final void call(int i2) {
            AppMethodBeat.i(248627);
            final RecyclerView recyclerView = FinderMegaVideoLikeTLUIC.a(this.uNc).getRecyclerView();
            if (recyclerView != null) {
                ...
                recyclerView.post(new Runnable() {
                    /* class com.tencent.mm.plugin.finder.megavideo.uic.FinderMegaVideoLikeTLUIC.b.AnonymousClass1 */

                    public final void run() {
                        AppMethodBeat.i(248626);
                        finderLinearLayoutManager.ah(this.uNb.getInitPos(), 0);
                        final long longExtra = this.uNc.getIntent().getLongExtra("KEY_VIDEO_START_PLAY_TIME_MS", 0);
                        if (longExtra > 0) {
                            d.a(0, new kotlin.g.a.a<x>(this) {
                                /* class com.tencent.mm.plugin.finder.megavideo.uic.FinderMegaVideoLikeTLUIC.b.AnonymousClass1.AnonymousClass1 */
                                final /* synthetic */ AnonymousClass1 uNe;
