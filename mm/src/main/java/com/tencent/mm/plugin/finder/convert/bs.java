...
public final class bs extends bh<bb> {
    ...
    public final /* synthetic */ void a(h hVar, bb bbVar) {
        ...
        String str = bbVar2.uNF.field_content;
        p.g(str, "item.finderMention.field_content");
        ((TextView) Mn3).setText(com.tencent.mm.pluginsdk.ui.span.l.c(context2, n.j(str, "@", "", false)));
