...
public final class FinderFollowTopicListContract$FollowTopicViewCallback$initView$3 implements g.d<h> {
    ...
    public final /* synthetic */ boolean b(RecyclerView.a<h> aVar, View view, int i2, h hVar) {
        ...
        p.h(view, "view");
        p.h(hVar, "holder");
        FinderFollowTopicListContract.FollowTopicViewCallback.a(this.uWY, this.uWY.uWW.kgc.get(i2).dMU, view);
