...
public abstract class MobileRemitBaseUI extends WalletBaseUI {
    protected a Cmp = a.ACTIVITY_INIT;
    ...
    public void onResume() {
        super.onResume();
        this.Cmp = a.ACTIVITY_RESUME;
    }

    @Override // com.tencent.mm.ui.component.UIComponentActivity, com.tencent.mm.ui.MMActivity, com.tencent.mm.hellhoundlib.activities.HellActivity, com.tencent.mm.ui.MMFragmentActivity, android.support.v4.app.FragmentActivity, com.tencent.mm.wallet_core.ui.WalletBaseUI
    public void onPause() {
        super.onPause();
        this.Cmp = a.ACTIVITY_PAUSE;
    }
    ...
    public final void eNv() {
        ...
        com.tencent.mm.hellhoundlib.a.a.a(this, bl.axQ(), "com/tencent/mm/plugin/remittance/mobile/ui/MobileRemitBaseUI", "finishMobileRemitProcess", "()V", "Undefined", "startActivity", "(Landroid/content/Intent;)V");
