...
public final class f extends k<ayz> implements w {
    ...
    public final /* synthetic */ b di(ayz ayz) {
        AppMethodBeat.i(242657);
        ayz ayz2 = ayz;
        p.h(ayz2, "cmdBufItem");
        b cD = b.cD(ayz2.toByteArray());
    ...
    @Override // com.tencent.mm.plugin.finder.cgi.oplog.k
    public final /* synthetic */ void n(ayz ayz, int i2) {
