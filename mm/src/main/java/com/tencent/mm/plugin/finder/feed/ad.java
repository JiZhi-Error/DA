...
public final class ad {
    ...
    public static final class a extends v.a {
        ...
        /* renamed from: com.tencent.mm.plugin.finder.feed.ad$a$a  reason: collision with other inner class name */
        static final class C1123a extends q implements kotlin.g.a.b<Integer, bo> {
            final /* synthetic */ a tQi;
            ...
            public final /* synthetic */ bo invoke(Integer num) {
                ...
                if (intValue >= 0) {
                    BaseFinderFeedLoader baseFinderFeedLoader = this.tQi.tFM;
                    if (intValue < ((baseFinderFeedLoader == null || (dataListJustForAdapter = baseFinderFeedLoader.getDataListJustForAdapter()) == null) ? 0 : dataListJustForAdapter.size())) {
                        BaseFinderFeedLoader baseFinderFeedLoader2 = this.tQi.tFM;
        ...
        static final class b extends q implements m<Integer, Integer, LinkedList<bo>> {
            ...
            public final /* synthetic */ LinkedList<bo> invoke(Integer num, Integer num2) {
                ...
                if (intValue >= 0) {
                    BaseFinderFeedLoader baseFinderFeedLoader2 = this.tQi.tFM;
                    if (!(intValue2 >= ((baseFinderFeedLoader2 == null || (dataListJustForAdapter2 = baseFinderFeedLoader2.getDataListJustForAdapter()) == null) ? 0 : dataListJustForAdapter2.size()) || (baseFinderFeedLoader = this.tQi.tFM) == null || (dataListJustForAdapter = baseFinderFeedLoader.getDataListJustForAdapter()) == null || (a2 = j.a((List) dataListJustForAdapter, new kotlin.k.f(intValue, intValue2))) == null)) {
        ...
        public final void a(BaseFinderFeedLoader baseFinderFeedLoader, v.b bVar) {
            ...
            this.tLy.a(this.scene, this.tCE, new C1123a(this));
