...
public final class h {
                ...
                if (name.startsWith(str2)) {
                    try {
                        ...
                        for (MediaCodecInfo.CodecProfileLevel codecProfileLevel : codecProfileLevelArr) {
                            ...
                            Log.d("OpenVoice[HWEnc]", "steve : [" + name + "] supported profiles:" + codecProfileLevel.profile + ", maxAllowedProfile: " + this.qsk + ", MIME:" + str);
                        }
                    } catch (Exception e2) {
                    }
                }
            ...
            try {
                ...
                if (!(capabilitiesForType == null || (codecProfileLevelArr = capabilitiesForType.profileLevels) == null)) {
                    ...
                    for (MediaCodecInfo.CodecProfileLevel codecProfileLevel2 : codecProfileLevelArr) {
                        ...
                        Log.i("OpenVoice[HWEnc]", "steve : profile: " + i3 + ", level: " + i4 + ", maxProfile: " + i2 + ", isRecognized:" + z3);
                    }
                    Log.i("OpenVoice[HWEnc]", "best profile: " + codecProfileLevel.profile + ", best level: " + codecProfileLevel.level);
                ...
                Log.e("OpenVoice[HWEnc]", "trySetProfile error: " + e2.getMessage());
            }
        }
    ...
    private static boolean a(MediaCodecInfo mediaCodecInfo) {
        ...
        while (true) {
            if (i2 >= length) {
                ...
                z = true;
                Log.d("OpenVoice[HWEnc]", "steve : known H.264 HW encoder :".concat(String.valueOf(name)));
                break;
            } else {
                i2++;
            }
    ...
    private int cyY() {
            ...
            if (codecInfoAt.isEncoder()) {
                for (String str2 : codecInfoAt.getSupportedTypes()) {
                    if (str2.equalsIgnoreCase(str)) {
                        Log.d("OpenVoice[HWEnc]", "steve : H.264 HW encoder found:".concat(String.valueOf(codecInfoAt.getName())));
        ...
        if (mediaCodecInfo == null) {
            Log.e("OpenVoice[HWEnc]", "steve: Unable to find an appropriate codec for " + this.ENCODING);
            this.qsb = 2001;
            int i3 = -this.qsb;
            AppMethodBeat.o(90801);
            return i3;
        }
        Log.i("OpenVoice[HWEnc]", "steve: found HW codec: " + mediaCodecInfo.getName());
        ...
        try {
            ...
            Log.i("OpenVoice[HWEnc]", "steve: mediaFormat: " + this.mediaFormat + ", actProfile: " + this.qsj);
            ...
            Log.e("OpenVoice[HWEnc]", " error:" + e2.toString());
            this.qsb = 2002;
            int i4 = -this.qsb;
            AppMethodBeat.o(90801);
            return i4;
    ...
    public final int b(byte[] r11, int r12, int r13, int r14) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.tencent.mm.plugin.cloudvoip.cloudvoice.d.h.b(byte[], int, int, int):int");
    }
    ...
    public final boolean SetBitRate(int i2) {
        ...
        try {
            if (this.qsc != null) {
                ...
                int i3 = i2 * 1000;
                Log.v("OpenVoice[HWEnc]", "steve: setRates: ".concat(String.valueOf(i3)));
            ...
            Log.e("OpenVoice[HWEnc]", "steve: setRates failed:".concat(String.valueOf(e2)));
        }
        AppMethodBeat.o(90805);
        return false;
    }
    ...
    private void E(byte[] bArr, int i2, int i3) {
        ...
        int c2 = m.c(bArr, 0, i2, i4);
        if (c2 > 0) {
            Log.d("OpenVoice[HWEnc]", "steve: send successfully! frameLen = " + i3 + ", type = " + i2 + ", pkt cnt = " + c2);
        }
