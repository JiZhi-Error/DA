...
public final class q implements ad {
    ...
    public final void aC(Bundle bundle) {
        ...
        this.f1523h = this.gte.getIntent().getIntExtra("Ksnsupload_height", -1);
    ...
    public final boolean a(int i2, int i3, i iVar, String str, List<String> list, cjy cjy, LinkedList<Long> linkedList, int i4, boolean z, List<String> list2, PInt pInt, String str2, int i5, int i6) {
        ...
        } else if (!Util.isNullOrNil(this.twt) && com.tencent.mm.av.q.bcQ() != null) {
        ...
        aj.faK().eZn();
        this.gte.finish();
        String amt = ((com.tencent.mm.plugin.emoji.b.d) com.tencent.mm.kernel.g.ah(com.tencent.mm.plugin.emoji.b.d.class)).getEmojiMgr().amt(this.EpK);
        h.INSTANCE.a(10993, 1, amt);
