...
@l(hxD = {1, 1, 16}, hxE = {"\u0000,\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\b\n\u0002\b\u0002\n\u0002\u0010\u000e\n\u0002\b\u0005\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\u0018\u00002\b\u0012\u0004\u0012\u00020\u00020\u0001B\r\u0012\u0006\u0010\u0003\u001a\u00020\u0004¢\u0006\u0002\u0010\u0005J \u0010\f\u001a\u00020\r2\u0006\u0010\u000e\u001a\u00020\u000f2\u0006\u0010\u0010\u001a\u00020\u00022\u0006\u0010\u0011\u001a\u00020\u0004H\u0016R\u0014\u0010\u0006\u001a\u00020\u0007XD¢\u0006\b\n\u0000\u001a\u0004\b\b\u0010\tR\u0011\u0010\u0003\u001a\u00020\u0004¢\u0006\b\n\u0000\u001a\u0004\b\n\u0010\u000b¨\u0006\u0012"}, hxF = {"Lcom/tencent/mm/plugin/finder/convert/FinderMsgCommentNewConvert;", "Lcom/tencent/mm/plugin/finder/convert/FinderMsgConvert;", "Lcom/tencent/mm/plugin/finder/model/FinderMsgComment;", "scene", "", "(I)V", "TAG", "", "getTAG", "()Ljava/lang/String;", "getScene", "()I", "convertMsg", "", "holder", "Lcom/tencent/mm/view/recyclerview/SimpleViewHolder;", "item", "position", "plugin-finder_release"})
public final class bg extends bh<au> {
    private final String TAG = "Finder.FinderMsgCommentConvert";
    private final int scene;

    public bg(int i2) {
        super(R.layout.ah3, i2);
        this.scene = i2;
    }
    ...
    public final /* synthetic */ void a(h hVar, au auVar) {
        ...
        ((TextView) Mn3).setText(com.tencent.mm.pluginsdk.ui.span.l.c(hVar.getContext(), hVar.getContext().getString(R.string.cjl, auVar2.uNF.field_content)));
        ...
        if (((int) auVar2.uNF.field_objectType) != 2 || !Util.isNullOrNil(auVar2.uNF.field_refContent)) {
        ...
        p.g(Mn13, "holder.getView<View>(R.id.msg_content_mv_desc)");
        Mn13.setVisibility(0);
        View Mn14 = hVar.Mn(R.id.fmc);
        p.g(Mn14, "holder.getView<TextView>(R.id.msg_content_mv_desc)");
        ((TextView) Mn14).setText(hVar.getContext().getString(R.string.d2_));
        AppMethodBeat.o(243189);
    }
}
