...
public final class FinderMegaVideoFavTLUIC extends BaseMegaVideoTLUIC {
    ...
    @l(hxD = {1, 1, 16}, hxE = {"\u0000\u0012\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\u000e\n\u0000\b\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002R\u000e\u0010\u0003\u001a\u00020\u0004XT¢\u0006\u0002\n\u0000¨\u0006\u0005"}, hxF = {"Lcom/tencent/mm/plugin/finder/megavideo/uic/FinderMegaVideoFavTLUIC$Companion;", "", "()V", "TAG", "", "plugin-finder_release"})
    ...
    public FinderMegaVideoFavTLUIC(AppCompatActivity appCompatActivity) {
    ...
    public static final /* synthetic */ h.b a(FinderMegaVideoFavTLUIC finderMegaVideoFavTLUIC) {
        AppMethodBeat.i(248624);
        h.b bVar = finderMegaVideoFavTLUIC.uLW;
        if (bVar == null) {
            p.btv("viewCallback");
        }
    ...
    public final void onCreate(Bundle bundle) {
        ...
        FinderFavMegaVideoLoader finderFavMegaVideoLoader = new FinderFavMegaVideoLoader(aUg, ((FinderReporterUIC) com.tencent.mm.ui.component.a.b(getActivity()).get(FinderReporterUIC.class)).dIx());
        finderFavMegaVideoLoader.initFromCache(getIntent());
        finderFavMegaVideoLoader.setInitDone(new b(finderFavMegaVideoLoader, this));
        h.a aVar3 = this.uMy;
        if (aVar3 == null) {
            p.btv("presenter");
        }
        FinderFavMegaVideoLoader finderFavMegaVideoLoader2 = finderFavMegaVideoLoader;
        h.b bVar = this.uLW;
        if (bVar == null) {
            p.btv("viewCallback");
        }
        aVar3.a(finderFavMegaVideoLoader2, bVar);
        AppMethodBeat.o(248619);
    }

    @l(hxD = {1, 1, 16}, hxE = {"\u0000\u0017\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0010\b\n\u0000*\u0001\u0000\b\n\u0018\u00002\u00020\u0001J\u0010\u0010\u0002\u001a\u00020\u00032\u0006\u0010\u0004\u001a\u00020\u0005H\u0016¨\u0006\u0006¸\u0006\u0000"}, hxF = {"com/tencent/mm/plugin/finder/megavideo/uic/FinderMegaVideoFavTLUIC$onCreate$feedLoader$1$1", "Lcom/tencent/mm/plugin/finder/feed/model/internal/IInitDone;", "call", "", "incrementCount", "", "plugin-finder_release"})
    public static final class b implements com.tencent.mm.plugin.finder.feed.model.internal.h {
        final /* synthetic */ FinderFavMegaVideoLoader uMT;
        final /* synthetic */ FinderMegaVideoFavTLUIC uMU;

        b(FinderFavMegaVideoLoader finderFavMegaVideoLoader, FinderMegaVideoFavTLUIC finderMegaVideoFavTLUIC) {
            this.uMT = finderFavMegaVideoLoader;
            this.uMU = finderMegaVideoFavTLUIC;
        }

        @Override // com.tencent.mm.plugin.finder.feed.model.internal.h
        public final void call(int i2) {
            AppMethodBeat.i(248618);
            final RecyclerView recyclerView = FinderMegaVideoFavTLUIC.a(this.uMU).getRecyclerView();
            if (recyclerView != null) {
                ...
                recyclerView.post(new Runnable() {
                    /* class com.tencent.mm.plugin.finder.megavideo.uic.FinderMegaVideoFavTLUIC.b.AnonymousClass1 */

                    public final void run() {
                        AppMethodBeat.i(248617);
                        finderLinearLayoutManager.ah(this.uMT.getInitPos(), 0);
                        final long longExtra = this.uMU.getIntent().getLongExtra("KEY_VIDEO_START_PLAY_TIME_MS", 0);
                        if (longExtra > 0) {
                            d.a(0, new kotlin.g.a.a<x>(this) {
                                /* class com.tencent.mm.plugin.finder.megavideo.uic.FinderMegaVideoFavTLUIC.b.AnonymousClass1.AnonymousClass1 */
                                final /* synthetic */ AnonymousClass1 uMY;
