        ...
        if (i2 == 0) {
            ...
            switch (intValue) {
                case 1:
                    ...
                    return 0;
                case 2:
                    btVar.xLl = aVar3.UbS.readString();
                    AppMethodBeat.o(41775);
                    return 0;
                case 3:
                    btVar.xLF.add(aVar3.UbS.readString());
                    AppMethodBeat.o(41775);
                    return 0;
                case 4:
                    btVar.keh = aVar3.UbS.readString();
                    AppMethodBeat.o(41775);
                    return 0;
                case 5:
                    ...
                    return 0;
                case 6:
                    btVar.xLH = aVar3.UbS.zi();
                    AppMethodBeat.o(41775);
                    return 0;
                case 7:
                    btVar.xLI = aVar3.UbS.yZ();
                    AppMethodBeat.o(41775);
                    return 0;
                case 8:
                    btVar.xLm = aVar3.UbS.zi();
                    AppMethodBeat.o(41775);
                    return 0;
                default:
                    AppMethodBeat.o(41775);
