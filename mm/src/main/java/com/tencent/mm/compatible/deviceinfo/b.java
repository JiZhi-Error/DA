...
public final class b {
    ...
    public int gEM;
    public int gEN;
    public short[] gEO = new short[15];
    public short[] gEP = new short[2];
    public boolean gEQ;
    public int gER;
    ...
    public final boolean anV() {
        if ((this.gDC < 0 || this.gDD >= 0) && ((this.gDC >= 0 || this.gDD < 0) && this.gDE <= 0)) {
            return false;
        }
        return true;
    }
    ...
    public final int anY() {
        ...
        if (anW()) {
            int i2 = (this.gDF & TbsListener.ErrorCode.EXCEED_INCR_UPDATE) >> 5;
            Log.d("VoipAudioInfo", "getEnableMode ".concat(String.valueOf(i2)));
            if (i2 == 7) {
    ...
    public final boolean anZ() {
        ...
        if (anW()) {
            int i2 = this.gDF & 16;
            StringBuilder sb = new StringBuilder("enableSpeaker ");
            if (i2 > 0) {
                z = true;
            } else {
                z = false;
            }
            Log.d("VoipAudioInfo", sb.append(z).toString());
            if (i2 > 0) {
    ...
    public final int aoa() {
        ...
        if (anW()) {
            int i2 = (this.gDF & 14) >> 1;
            Log.d("VoipAudioInfo", "getDisableMode ".concat(String.valueOf(i2)));
            if (i2 == 7) {
    ...
    public final boolean aob() {
        ...
        if (anW()) {
            int i2 = this.gDF & 1;
            StringBuilder sb = new StringBuilder("disableSpeaker ");
            if (i2 > 0) {
                z = true;
            } else {
                z = false;
    ...
    public final int aoc() {
        ...
        if (anX()) {
            int i2 = (this.gDG & TbsListener.ErrorCode.EXCEED_INCR_UPDATE) >> 5;
            Log.d("VoipAudioInfo", "getEnableMode ".concat(String.valueOf(i2)));
            if (i2 == 7) {
    ...
    public final void dump() {
        ...
        Log.d("VoipAudioInfo", "noisegatestrength[0]" + ((int) this.gEP[0]));
        Log.d("VoipAudioInfo", "noisegatestrength[1]" + ((int) this.gEP[1]));
