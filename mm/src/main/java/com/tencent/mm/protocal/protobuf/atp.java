...
public final class atp extends dpc {
    public String LAH;
    public awu LDS;
    public bcx LEA;
    ...
    public final int op(int i2, Object... objArr) {
        ...
        if (i2 == 0) {
            ...
            if (this.preloadInfo != null) {
                aVar.ni(6, this.preloadInfo.computeSize());
            ...
            if (this.txf != null) {
                bu += g.a.a.b.b.a.b(5, this.txf);
            }
            if (this.preloadInfo != null) {
                bu += g.a.a.a.nh(6, this.preloadInfo.computeSize());
            }
            if (this.LAH != null) {
                bu += g.a.a.b.b.a.f(7, this.LAH);
            }
            ...
            switch (intValue) {
                ...
                case 2:
                    ...
                    for (int i4 = 0; i4 < size2; i4++) {
                        ...
                        atp.object.add(finderObject);
                    }
                    AppMethodBeat.o(209455);
                    return 0;
                case 3:
                    atp.lastBuffer = aVar3.UbS.hPo();
                    AppMethodBeat.o(209455);
                    return 0;
                case 4:
                    atp.continueFlag = aVar3.UbS.zi();
                    AppMethodBeat.o(209455);
                    return 0;
                case 5:
                    atp.txf = aVar3.UbS.hPo();
                    AppMethodBeat.o(209455);
                    return 0;
                case 6:
