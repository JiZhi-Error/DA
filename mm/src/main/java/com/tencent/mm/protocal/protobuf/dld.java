...
public final class dld extends dpc {
    public LinkedList<dkt> LVc = new LinkedList<>();
    public b LXB;
    ...
    public final int op(int i2, Object... objArr) {
        ...
        if (i2 == 0) {
            ...
            if (this.SessionId != null) {
                nh += g.a.a.b.b.a.f(3, this.SessionId);
            }
            if (this.LXB != null) {
                nh += g.a.a.b.b.a.b(4, this.LXB);
            }
            AppMethodBeat.o(104833);
            return nh;
        } else if (i2 == 2) {
            ...
            switch (intValue) {
                ...
                case 2:
                    ...
                    for (int i4 = 0; i4 < size2; i4++) {
                        ...
                        for (boolean z2 = true; z2; z2 = dkt.populateBuilderWithField(aVar5, dkt, dpc.getNextFieldNumber(aVar5))) {
                        }
                        dld.LVc.add(dkt);
                    }
                    AppMethodBeat.o(104833);
                    return 0;
                case 3:
                    dld.SessionId = aVar3.UbS.readString();
                    AppMethodBeat.o(104833);
                    return 0;
                case 4:
                    dld.LXB = aVar3.UbS.hPo();
                    AppMethodBeat.o(104833);
                    return 0;
                default:
                    AppMethodBeat.o(104833);
