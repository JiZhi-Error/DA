...
public final class bjq extends dpc {
    public LinkedList<oa> KTA = new LinkedList<>();
    public dis KTz;
    ...
    public final int op(int i2, Object... objArr) {
        ...
        if (i2 == 0) {
            ...
            int c2 = nh + g.a.a.a.c(3, 8, this.KTA);
            AppMethodBeat.o(124503);
            return c2;
        } else if (i2 == 2) {
            this.KTA.clear();
            ...
            switch (intValue) {
                ...
                case 3:
                    ...
                    for (int i5 = 0; i5 < size3; i5++) {
                        ...
                        for (boolean z3 = true; z3; z3 = oaVar.populateBuilderWithField(aVar6, oaVar, dpc.getNextFieldNumber(aVar6))) {
                        }
                        bjq.KTA.add(oaVar);
                    }
                    AppMethodBeat.o(124503);
