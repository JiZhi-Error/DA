...
public final class aqf extends dpc {
            ...
            switch (intValue) {
                ...
                case 3:
                    ...
                    for (int i5 = 0; i5 < size3; i5++) {
                        ...
                        for (boolean z3 = true; z3; z3 = azn.populateBuilderWithField(aVar6, azn, dpc.getNextFieldNumber(aVar6))) {
                        }
                        aqf.verifyInfo = azn;
                    }
                    AppMethodBeat.o(168949);
