...
public final class eu extends dpc {
    ...
    public final int op(int i2, Object... objArr) {
        ...
        if (i2 == 0) {
            ...
            if (this.BaseResponse == null) {
                ...
                b bVar2 = new b("Not all required fields were included: RespBuf");
                AppMethodBeat.o(152491);
                throw bVar2;
            } else {
                if (this.BaseResponse != null) {
                ...
                if (this.KIk != null) {
                    aVar.ni(2, this.KIk.computeSize());
            ...
            if (this.KIk != null) {
                nh += g.a.a.a.nh(2, this.KIk.computeSize());
            }
            AppMethodBeat.o(152491);
            return nh;
        } else if (i2 == 2) {
            ...
            if (this.BaseResponse == null) {
                ...
                b bVar4 = new b("Not all required fields were included: RespBuf");
                AppMethodBeat.o(152491);
                throw bVar4;
            } else {
                AppMethodBeat.o(152491);
            ...
            switch (intValue) {
                case 1:
                    ...
                    for (int i3 = 0; i3 < size; i3++) {
                        ...
                        euVar.BaseResponse = baseResponse;
                    }
                    AppMethodBeat.o(152491);
                    return 0;
                case 2:
