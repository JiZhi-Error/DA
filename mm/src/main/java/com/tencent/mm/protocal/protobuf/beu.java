...
public final class beu extends dop {
    public int LOB;
    public int LOC;
    public jl LjV;
    public String LjW;
    ...
    public final int op(int i2, Object... objArr) {
        ...
        if (i2 == 0) {
            ...
            int bu = nh + g.a.a.b.b.a.bu(4, this.LOB) + g.a.a.b.b.a.bu(5, this.LOC);
            AppMethodBeat.o(91468);
            return bu;
        } else if (i2 == 2) {
            ...
            switch (intValue) {
                ...
                case 2:
                    ...
                    return 0;
                case 3:
                    beu.LjW = aVar3.UbS.readString();
                    AppMethodBeat.o(91468);
                    return 0;
                case 4:
                    beu.LOB = aVar3.UbS.zi();
                    AppMethodBeat.o(91468);
                    return 0;
                case 5:
                    beu.LOC = aVar3.UbS.zi();
                    AppMethodBeat.o(91468);
                    return 0;
                default:
                    AppMethodBeat.o(91468);
