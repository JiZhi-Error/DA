...
public final class cde extends dpc {
    public String KTt;
    public dis KTz;
    public String Lph;
    public String Lpi;
    ...
    public final int op(int i2, Object... objArr) {
        ...
        if (i2 == 0) {
            ...
            if (this.Lph != null) {
                bu += g.a.a.b.b.a.f(7, this.Lph);
            }
            if (this.Lpi != null) {
                bu += g.a.a.b.b.a.f(8, this.Lpi);
            }
            AppMethodBeat.o(124518);
            return bu;
        } else if (i2 == 2) {
            ...
            switch (intValue) {
                ...
                case 2:
                    ...
                    return 0;
                case 3:
                    cde.KTt = aVar3.UbS.readString();
                    AppMethodBeat.o(124518);
                    return 0;
                case 4:
                    cde.Lpj = aVar3.UbS.zi();
                    AppMethodBeat.o(124518);
                    return 0;
                case 5:
                ...
                case 6:
                    ...
                    return 0;
                case 7:
                    cde.Lph = aVar3.UbS.readString();
                    AppMethodBeat.o(124518);
                    return 0;
                case 8:
                    cde.Lpi = aVar3.UbS.readString();
                    AppMethodBeat.o(124518);
                    return 0;
                default:
                    AppMethodBeat.o(124518);
