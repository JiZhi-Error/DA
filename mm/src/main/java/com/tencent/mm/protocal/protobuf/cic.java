...
public final class cic extends dop {
    public int dYx;
    public String ixr;
    public String rJH;
    ...
    public final int op(int i2, Object... objArr) {
        ...
        if (i2 == 0) {
            ...
            int bu = nh + g.a.a.b.b.a.bu(4, this.dYx);
            if (this.ixr != null) {
                bu += g.a.a.b.b.a.f(5, this.ixr);
            }
            AppMethodBeat.o(32336);
            return bu;
        } else if (i2 == 2) {
            ...
            if (this.username == null) {
                ...
                b bVar5 = new b("Not all required fields were included: appusername");
                AppMethodBeat.o(32336);
                throw bVar5;
            } else if (this.ixr == null) {
                b bVar6 = new b("Not all required fields were included: rankid");
                AppMethodBeat.o(32336);
                throw bVar6;
            } else {
                AppMethodBeat.o(32336);
            ...
            switch (intValue) {
                case 1:
                    ...
                    for (int i3 = 0; i3 < size; i3++) {
                        ...
                        cic.BaseRequest = jrVar;
                    }
                    AppMethodBeat.o(32336);
                    return 0;
                case 2:
                    cic.username = aVar3.UbS.readString();
                    AppMethodBeat.o(32336);
                    return 0;
                case 3:
                    cic.rJH = aVar3.UbS.readString();
                    AppMethodBeat.o(32336);
                    return 0;
                case 4:
                    cic.dYx = aVar3.UbS.zi();
                    AppMethodBeat.o(32336);
                    return 0;
                case 5:
                    cic.ixr = aVar3.UbS.readString();
                    AppMethodBeat.o(32336);
                    return 0;
                default:
                    AppMethodBeat.o(32336);
