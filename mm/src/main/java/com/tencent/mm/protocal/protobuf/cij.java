...
public final class cij extends dpc {
    public LinkedList<bzv> oTA = new LinkedList<>();
    public int oTz;
            ...
            switch (intValue) {
                case 1:
                    ...
                    for (int i3 = 0; i3 < size; i3++) {
                        ...
                        cij.BaseResponse = baseResponse;
                    }
                    AppMethodBeat.o(155432);
                    return 0;
                case 2:
                    cij.oTz = aVar3.UbS.zi();
                    AppMethodBeat.o(155432);
                    return 0;
                case 3:
                    ...
                    for (int i4 = 0; i4 < size2; i4++) {
                        ...
                        for (boolean z2 = true; z2; z2 = bzv.populateBuilderWithField(aVar5, bzv, dpc.getNextFieldNumber(aVar5))) {
                        }
                        cij.oTA.add(bzv);
                    }
                    AppMethodBeat.o(155432);
