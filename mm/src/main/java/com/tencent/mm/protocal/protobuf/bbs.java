...
public final class bbs extends dop {
    ...
    public final int op(int i2, Object... objArr) {
        ...
        if (i2 == 0) {
            ...
            if (this.finderUsername != null) {
                nh += g.a.a.b.b.a.f(5, this.finderUsername);
            }
            AppMethodBeat.o(209663);
            return nh;
        } else if (i2 == 2) {
            ...
            switch (intValue) {
                ...
                case 2:
                    ...
                    return 0;
                case 3:
                    bbs.tVM = aVar3.UbS.hPo();
                    AppMethodBeat.o(209663);
                    return 0;
                case 4:
                    bbs.query = aVar3.UbS.readString();
                    AppMethodBeat.o(209663);
                    return 0;
                case 5:
                    bbs.finderUsername = aVar3.UbS.readString();
                    AppMethodBeat.o(209663);
                    return 0;
                default:
                    AppMethodBeat.o(209663);
