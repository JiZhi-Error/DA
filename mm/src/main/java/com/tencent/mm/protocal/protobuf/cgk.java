...
public final class cgk extends dop {
    public String KDQ;
    public long hyH;
            ...
            switch (intValue) {
                case 1:
                    ...
                    for (int i3 = 0; i3 < size; i3++) {
                        ...
                        cgk.BaseRequest = jrVar;
                    }
                    AppMethodBeat.o(207491);
                    return 0;
                case 2:
                    cgk.hyH = aVar3.UbS.zl();
                    AppMethodBeat.o(207491);
                    return 0;
                case 3:
                    cgk.KDQ = aVar3.UbS.readString();
                    AppMethodBeat.o(207491);
                    return 0;
                case 4:
                    cgk.username = aVar3.UbS.readString();
                    AppMethodBeat.o(207491);
                    return 0;
                default:
                    AppMethodBeat.o(207491);
