...
public final class dgj extends a {
    public String Liq;
    public int LoT;
    public int MKY;
    ...
    public final int op(int i2, Object... objArr) {
        ...
        if (i2 == 0) {
            ...
            dgj dgj = (dgj) objArr[1];
            switch (((Integer) objArr[2]).intValue()) {
                case 1:
                    dgj.UserName = aVar3.UbS.readString();
                    AppMethodBeat.o(32393);
                    return 0;
                case 2:
                    dgj.Liq = aVar3.UbS.readString();
                    AppMethodBeat.o(32393);
                    return 0;
                case 3:
                    dgj.MKY = aVar3.UbS.zi();
                    AppMethodBeat.o(32393);
                    return 0;
                case 4:
                    dgj.LoT = aVar3.UbS.zi();
                    AppMethodBeat.o(32393);
                    return 0;
                default:
                    AppMethodBeat.o(32393);
