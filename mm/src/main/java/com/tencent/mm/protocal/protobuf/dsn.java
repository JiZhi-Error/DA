...
public final class dsn extends a {
    public String Lir;
    public String Lis;
    public dqi Lqk;
    public dqi Mjj;
    ...
    public final int op(int i2, Object... objArr) {
        ...
        if (i2 == 0) {
            ...
            if (this.Lqk == null) {
                ...
                if (this.MmR != null) {
                    aVar.ni(15, this.MmR.computeSize());
            ...
            if (this.MmR != null) {
                bu3 += g.a.a.a.nh(15, this.MmR.computeSize());
            }
            if (this.Lir != null) {
            ...
            switch (intValue) {
                ...
                case 2:
                    ...
                    return 0;
                case 3:
                    dsn.kdY = aVar3.UbS.zi();
                    AppMethodBeat.o(6431);
                    return 0;
                case 4:
                    dsn.kdZ = aVar3.UbS.readString();
                    AppMethodBeat.o(6431);
                    return 0;
                case 5:
                    dsn.kea = aVar3.UbS.readString();
                    AppMethodBeat.o(6431);
                    return 0;
                case 6:
                    dsn.keb = aVar3.UbS.readString();
                    AppMethodBeat.o(6431);
                    return 0;
                case 7:
                    dsn.kec = aVar3.UbS.zi();
                    AppMethodBeat.o(6431);
                    return 0;
                case 8:
                    dsn.MmK = aVar3.UbS.zi();
                    AppMethodBeat.o(6431);
                    return 0;
                case 9:
                    dsn.MmL = aVar3.UbS.readString();
                    AppMethodBeat.o(6431);
                    return 0;
                case 10:
                    dsn.MmM = aVar3.UbS.readString();
                    AppMethodBeat.o(6431);
                    return 0;
                case 11:
                    dsn.ked = aVar3.UbS.readString();
                    AppMethodBeat.o(6431);
                    return 0;
                case 12:
                    dsn.MmN = aVar3.UbS.readString();
                    AppMethodBeat.o(6431);
                    return 0;
                case 13:
                    dsn.MmO = aVar3.UbS.zi();
                    AppMethodBeat.o(6431);
                    return 0;
                case 14:
                    dsn.keh = aVar3.UbS.readString();
                    AppMethodBeat.o(6431);
                    return 0;
                case 15:
                    ...
                    return 0;
                case 16:
                    dsn.Lir = aVar3.UbS.readString();
                    AppMethodBeat.o(6431);
                    return 0;
                case 17:
                    dsn.Lis = aVar3.UbS.readString();
                    AppMethodBeat.o(6431);
                    return 0;
                default:
                    AppMethodBeat.o(6431);
