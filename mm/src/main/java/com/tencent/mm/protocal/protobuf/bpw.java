...
public final class bpw extends dpc {
    ...
    public final int op(int i2, Object... objArr) {
        ...
        if (i2 == 0) {
            ...
            if (this.BaseResponse == null) {
                ...
                if (this.KHp != null) {
                    aVar.ni(2, this.KHp.computeSize());
            ...
            if (this.KHp != null) {
                nh += g.a.a.a.nh(2, this.KHp.computeSize());
            }
            AppMethodBeat.o(56248);
            return nh;
        } else if (i2 == 2) {
