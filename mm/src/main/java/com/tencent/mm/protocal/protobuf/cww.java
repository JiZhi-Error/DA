...
public final class cww extends dpc {
    public String HuS;
    public ckj efB;
    public int pTZ;
    public String pUa;
            ...
            switch (intValue) {
                case 1:
                    ...
                    for (int i3 = 0; i3 < size; i3++) {
                        ...
                        cww.BaseResponse = baseResponse;
                    }
                    AppMethodBeat.o(91564);
                    return 0;
                case 2:
                    cww.pTZ = aVar3.UbS.zi();
                    AppMethodBeat.o(91564);
                    return 0;
                case 3:
                    cww.pUa = aVar3.UbS.readString();
                    AppMethodBeat.o(91564);
                    return 0;
                case 99:
