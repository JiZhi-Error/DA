...
public final class dgc extends dpc {
    public String HuS;
    public String KBM;
    public String MKP;
    public int MKQ;
    ...
    public final int op(int i2, Object... objArr) {
        ...
        if (i2 == 0) {
            ...
            if (this.KBM != null) {
                nh += g.a.a.b.b.a.f(5, this.KBM);
            }
            int bu = nh + g.a.a.b.b.a.bu(6, this.dVv) + g.a.a.b.b.a.bu(7, this.MKQ);
            if (this.efB != null) {
            ...
            switch (intValue) {
                case 1:
                    ...
                    for (int i3 = 0; i3 < size; i3++) {
                        ...
                        dgc.BaseResponse = baseResponse;
                    }
                    AppMethodBeat.o(91637);
                    return 0;
                case 2:
                    dgc.pTZ = aVar3.UbS.zi();
                    AppMethodBeat.o(91637);
                    return 0;
                case 3:
                    dgc.pUa = aVar3.UbS.readString();
                    AppMethodBeat.o(91637);
                    return 0;
                case 4:
                    dgc.MKP = aVar3.UbS.readString();
                    AppMethodBeat.o(91637);
                    return 0;
                case 5:
                    dgc.KBM = aVar3.UbS.readString();
                    AppMethodBeat.o(91637);
                    return 0;
                case 6:
                    dgc.dVv = aVar3.UbS.zi();
                    AppMethodBeat.o(91637);
                    return 0;
                case 7:
                    dgc.MKQ = aVar3.UbS.zi();
                    AppMethodBeat.o(91637);
                    return 0;
                case 99:
