...
public final class bqw extends dpc {
    public int Brl;
    public long Brn;
    public int BsF;
    public int BsG;
    ...
    public final int op(int i2, Object... objArr) {
        ...
        if (i2 == 0) {
            ...
            int r = bu + g.a.a.b.b.a.r(9, this.Brn);
            AppMethodBeat.o(152573);
            return r;
        } else if (i2 == 2) {
            ...
            switch (intValue) {
                case 1:
                    ...
                    for (int i3 = 0; i3 < size; i3++) {
                        ...
                        bqw.BaseResponse = baseResponse;
                    }
                    AppMethodBeat.o(152573);
                    return 0;
                case 2:
                    bqw.Brl = aVar3.UbS.zi();
                    AppMethodBeat.o(152573);
                    return 0;
                case 3:
                ...
                case 4:
                    ...
                    return 0;
                case 5:
                    bqw.BsF = aVar3.UbS.zi();
                    AppMethodBeat.o(152573);
                    return 0;
                case 6:
                    bqw.BsG = aVar3.UbS.zi();
                    AppMethodBeat.o(152573);
                    return 0;
                case 7:
                    bqw.BsH = aVar3.UbS.zi();
                    AppMethodBeat.o(152573);
                    return 0;
                case 8:
                    ...
                    for (int i6 = 0; i6 < size4; i6++) {
                        ...
                        for (boolean z4 = true; z4; z4 = sKBuiltinBuffer_t.populateBuilderWithField(aVar7, sKBuiltinBuffer_t, dpc.getNextFieldNumber(aVar7))) {
                        }
                        bqw.BsI = sKBuiltinBuffer_t;
                    }
                    AppMethodBeat.o(152573);
                    return 0;
                case 9:
                    bqw.Brn = aVar3.UbS.zl();
                    AppMethodBeat.o(152573);
                    return 0;
                default:
                    AppMethodBeat.o(152573);
