...
public final class dxb extends dpc {
    ...
    public final int op(int i2, Object... objArr) {
        ...
        if (i2 == 0) {
            ...
            int bu = nh + g.a.a.b.b.a.bu(3, this.Ret) + g.a.a.b.b.a.bu(4, this.MXg) + g.a.a.b.b.a.bu(5, this.MXi);
            AppMethodBeat.o(32447);
            return bu;
        } else if (i2 == 2) {
            ...
            switch (intValue) {
                ...
                case 2:
                    ...
                    for (int i4 = 0; i4 < size2; i4++) {
                        ...
                        dxb.KMS = sKBuiltinBuffer_t;
                    }
                    AppMethodBeat.o(32447);
                    return 0;
                case 3:
                    dxb.Ret = aVar3.UbS.zi();
                    AppMethodBeat.o(32447);
                    return 0;
                case 4:
                    dxb.MXg = aVar3.UbS.zi();
                    AppMethodBeat.o(32447);
                    return 0;
                case 5:
                    dxb.MXi = aVar3.UbS.zi();
                    AppMethodBeat.o(32447);
                    return 0;
                default:
                    AppMethodBeat.o(32447);
