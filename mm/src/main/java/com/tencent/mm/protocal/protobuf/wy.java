...
public final class wy extends dop {
    public String CpJ;
    public String CpP;
    public String CpQ;
    public long CrW;
            ...
            switch (intValue) {
                case 1:
                    ...
                    for (int i3 = 0; i3 < size; i3++) {
                        ...
                        wyVar.BaseRequest = jrVar;
                    }
                    AppMethodBeat.o(72450);
                    return 0;
                case 2:
                    wyVar.dNQ = aVar3.UbS.readString();
                    AppMethodBeat.o(72450);
                    return 0;
                case 3:
                    wyVar.CpQ = aVar3.UbS.readString();
                    AppMethodBeat.o(72450);
                    return 0;
                case 4:
                    wyVar.CpP = aVar3.UbS.readString();
                    AppMethodBeat.o(72450);
                    return 0;
                case 5:
                    wyVar.CpJ = aVar3.UbS.readString();
                    AppMethodBeat.o(72450);
                    return 0;
                case 6:
                    wyVar.CrW = aVar3.UbS.zl();
                    AppMethodBeat.o(72450);
                    return 0;
                case 7:
                    wyVar.Lhy = aVar3.UbS.readString();
                    AppMethodBeat.o(72450);
                    return 0;
                default:
                    AppMethodBeat.o(72450);
