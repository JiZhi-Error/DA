    ...
    public final int op(int i2, Object... objArr) {
        ...
        if (i2 == 0) {
            ...
            switch (((Integer) objArr[2]).intValue()) {
                case 1:
                    cyf.top = Float.intBitsToFloat(aVar3.UbS.zm());
                    AppMethodBeat.o(91570);
                    return 0;
                case 2:
                    cyf.bottom = Float.intBitsToFloat(aVar3.UbS.zm());
                    AppMethodBeat.o(91570);
                    return 0;
                case 3:
                    cyf.left = Float.intBitsToFloat(aVar3.UbS.zm());
                    AppMethodBeat.o(91570);
                    return 0;
                case 4:
                    cyf.right = Float.intBitsToFloat(aVar3.UbS.zm());
                    AppMethodBeat.o(91570);
                    return 0;
                default:
                    AppMethodBeat.o(91570);
