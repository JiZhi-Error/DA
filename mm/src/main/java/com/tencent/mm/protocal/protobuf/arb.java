...
public final class arb extends a {
    public LinkedList<arl> zns = new LinkedList<>();
            ...
            switch (intValue) {
                case 1:
                    ...
                    for (int i3 = 0; i3 < size; i3++) {
                        ...
                        for (boolean z = true; z; z = arl.populateBuilderWithField(aVar3, arl, a.getNextFieldNumber(aVar3))) {
                        }
                        arb.zns.add(arl);
                    }
                    AppMethodBeat.o(168962);
