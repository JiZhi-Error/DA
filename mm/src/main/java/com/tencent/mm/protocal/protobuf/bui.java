...
public final class bui extends dop {
    public String KLN;
    ...
    public final int op(int i2, Object... objArr) {
        ...
        if (i2 == 0) {
            ...
            if (this.KPW != null) {
                aVar.ni(3, this.KPW.computeSize());
            ...
            if (this.KLN != null) {
                nh += g.a.a.b.b.a.f(2, this.KLN);
            }
            if (this.KPW != null) {
                nh += g.a.a.a.nh(3, this.KPW.computeSize());
            }
            AppMethodBeat.o(155414);
            return nh;
        } else if (i2 == 2) {
            ...
            switch (intValue) {
                case 1:
                    ...
                    for (int i3 = 0; i3 < size; i3++) {
                        ...
                        bui.BaseRequest = jrVar;
                    }
                    AppMethodBeat.o(155414);
                    return 0;
                case 2:
                    bui.KLN = aVar3.UbS.readString();
                    AppMethodBeat.o(155414);
                    return 0;
                case 3:
