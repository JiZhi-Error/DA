...
public final class atf extends dop {
    public String LAt;
    public aov LBM;
    public b LDs;
    public long LDu;
    ...
    public final int op(int i2, Object... objArr) {
        ...
        if (i2 == 0) {
            ...
            if (this.LBM != null) {
                nh += g.a.a.a.nh(5, this.LBM.computeSize());
            }
            AppMethodBeat.o(209439);
            return nh;
        } else if (i2 == 2) {
            ...
            switch (intValue) {
                case 1:
                    ...
                    for (int i3 = 0; i3 < size; i3++) {
                        ...
                        atf.BaseRequest = jrVar;
                    }
                    AppMethodBeat.o(209439);
                    return 0;
                case 2:
                    atf.LDu = aVar3.UbS.zl();
                    AppMethodBeat.o(209439);
                    return 0;
                case 3:
                    atf.LAt = aVar3.UbS.readString();
                    AppMethodBeat.o(209439);
                    return 0;
                case 4:
                    atf.LDs = aVar3.UbS.hPo();
                    AppMethodBeat.o(209439);
                    return 0;
                case 5:
