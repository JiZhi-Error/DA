...
public final class ayc extends dop {
    public String LAt;
    public long hyH;
            ...
            switch (intValue) {
                case 1:
                    ...
                    for (int i3 = 0; i3 < size; i3++) {
                        ...
                        ayc.BaseRequest = jrVar;
                    }
                    AppMethodBeat.o(209584);
                    return 0;
                case 2:
                    ayc.hyH = aVar3.UbS.zl();
                    AppMethodBeat.o(209584);
                    return 0;
                case 3:
                    ayc.LAt = aVar3.UbS.readString();
                    AppMethodBeat.o(209584);
                    return 0;
                case 4:
                    ayc.object_id = aVar3.UbS.zl();
                    AppMethodBeat.o(209584);
                    return 0;
                case 5:
                    ayc.object_nonce_id = aVar3.UbS.readString();
                    AppMethodBeat.o(209584);
                    return 0;
                default:
                    AppMethodBeat.o(209584);
