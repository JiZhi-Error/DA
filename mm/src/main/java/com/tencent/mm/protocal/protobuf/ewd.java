...
public final class ewd extends a {
    public int NtL;
    public int NtM;
    public euy Nty;
    ...
    public final int op(int i2, Object... objArr) {
        ...
        if (i2 == 0) {
            ...
            int nh = (this.Nty != null ? g.a.a.a.nh(1, this.Nty.computeSize()) + 0 : 0) + g.a.a.b.b.a.bu(2, this.NtL) + g.a.a.b.b.a.bu(3, this.NtM);
            AppMethodBeat.o(147817);
            return nh;
        } else if (i2 == 2) {
            ...
            switch (intValue) {
                case 1:
                    ...
                    return 0;
                case 2:
                    ewd.NtL = aVar3.UbS.zi();
                    AppMethodBeat.o(147817);
                    return 0;
                case 3:
                    ewd.NtM = aVar3.UbS.zi();
                    AppMethodBeat.o(147817);
                    return 0;
                default:
                    AppMethodBeat.o(147817);
