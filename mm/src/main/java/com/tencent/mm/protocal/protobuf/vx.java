...
public final class vx extends dpc {
    public int Lba;
    public b Lhd;
    public int Lhe;
    public int dDN;
    ...
    public final int op(int i2, Object... objArr) {
        ...
        if (i2 == 0) {
            ...
            int bu = nh + g.a.a.b.b.a.bu(5, this.Lba) + g.a.a.b.b.a.bu(6, this.Lhe);
            AppMethodBeat.o(91409);
            return bu;
        } else if (i2 == 2) {
            ...
            switch (intValue) {
                case 1:
                    ...
                    for (int i3 = 0; i3 < size; i3++) {
                        ...
                        vxVar.BaseResponse = baseResponse;
                    }
                    AppMethodBeat.o(91409);
                    return 0;
                case 2:
                    vxVar.dDN = aVar3.UbS.zi();
                    AppMethodBeat.o(91409);
                    return 0;
                case 3:
                    vxVar.qwn = aVar3.UbS.readString();
                    AppMethodBeat.o(91409);
                    return 0;
                case 4:
                    vxVar.Lhd = aVar3.UbS.hPo();
                    AppMethodBeat.o(91409);
                    return 0;
                case 5:
                    vxVar.Lba = aVar3.UbS.zi();
                    AppMethodBeat.o(91409);
                    return 0;
                case 6:
                    vxVar.Lhe = aVar3.UbS.zi();
                    AppMethodBeat.o(91409);
                    return 0;
                default:
                    AppMethodBeat.o(91409);
