...
public final class xz extends dpc {
    public LinkedList<amk> oTA = new LinkedList<>();
    public int oTz;
            ...
            switch (intValue) {
                case 1:
                    ...
                    for (int i3 = 0; i3 < size; i3++) {
                        ...
                        xzVar.BaseResponse = baseResponse;
                    }
                    AppMethodBeat.o(127448);
                    return 0;
                case 2:
                    xzVar.oTz = aVar3.UbS.zi();
                    AppMethodBeat.o(127448);
                    return 0;
                case 3:
                    ...
                    for (int i4 = 0; i4 < size2; i4++) {
                        ...
                        for (boolean z2 = true; z2; z2 = amk.populateBuilderWithField(aVar5, amk, dpc.getNextFieldNumber(aVar5))) {
                        }
                        xzVar.oTA.add(amk);
                    }
                    AppMethodBeat.o(127448);
