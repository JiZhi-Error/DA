...
public final class ffs extends dop {
    public String LAt;
    public aov LBM;
    public b LFp;
    public long hyH;
        ...
        if (i2 == 0) {
            ...
            switch (intValue) {
                ...
                case 4:
                    ...
                    return 0;
                case 5:
                    ffs.hyH = aVar3.UbS.zl();
                    AppMethodBeat.o(259322);
                    return 0;
                case 6:
                    ffs.object_id = aVar3.UbS.zl();
                    AppMethodBeat.o(259322);
                    return 0;
                case 7:
                    ffs.object_nonce_id = aVar3.UbS.readString();
                    AppMethodBeat.o(259322);
                    return 0;
                case 8:
                    ffs.scene = aVar3.UbS.zi();
                    AppMethodBeat.o(259322);
                    return 0;
                case 9:
                    ffs.LAt = aVar3.UbS.readString();
                    AppMethodBeat.o(259322);
                    return 0;
                default:
                    AppMethodBeat.o(259322);
