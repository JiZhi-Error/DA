...
public final class evw extends a {
    public euy Nty;
    public int Ntz;
    ...
    public final int op(int i2, Object... objArr) {
        ...
        if (i2 == 0) {
            ...
            int nh = (this.Nty != null ? g.a.a.a.nh(1, this.Nty.computeSize()) + 0 : 0) + g.a.a.b.b.a.bu(2, this.Ntz);
            AppMethodBeat.o(147810);
            return nh;
        } else if (i2 == 2) {
