...
public final class bar extends dpc {
    ...
    public final int op(int i2, Object... objArr) {
        ...
        if (i2 == 0) {
            ...
            if (this.LKm != null) {
                aVar.ni(2, this.LKm.computeSize());
                this.LKm.writeFields(aVar);
            }
            if (this.LAJ != null) {
                aVar.ni(3, this.LAJ.computeSize());
            ...
            if (this.LKm != null) {
                nh += g.a.a.a.nh(2, this.LKm.computeSize());
            }
            if (this.LAJ != null) {
                nh += g.a.a.a.nh(3, this.LAJ.computeSize());
            }
            AppMethodBeat.o(169038);
            return nh;
        } else if (i2 == 2) {
