...
public final class dec extends dpc {
    public String HuS;
    public String MJi;
    public ckj efB;
    public int pTZ;
            ...
            switch (intValue) {
                case 1:
                    ...
                    for (int i3 = 0; i3 < size; i3++) {
                        ...
                        dec.BaseResponse = baseResponse;
                    }
                    AppMethodBeat.o(91625);
                    return 0;
                case 2:
                    dec.pTZ = aVar3.UbS.zi();
                    AppMethodBeat.o(91625);
                    return 0;
                case 3:
                    dec.pUa = aVar3.UbS.readString();
                    AppMethodBeat.o(91625);
                    return 0;
                case 4:
                    dec.MJi = aVar3.UbS.readString();
                    AppMethodBeat.o(91625);
                    return 0;
                case 99:
