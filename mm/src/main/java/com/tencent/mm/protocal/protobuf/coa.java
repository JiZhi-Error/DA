...
public final class coa extends dop {
    public String LOd;
    public cnh MtV;
    public int opType;
    public long tsR;
    ...
    public final int op(int i2, Object... objArr) {
        ...
        if (i2 == 0) {
            ...
            int r = nh + g.a.a.b.b.a.r(3, this.twG) + g.a.a.b.b.a.bu(4, this.opType) + g.a.a.b.b.a.r(5, this.tsR);
            if (this.LOd != null) {
                r += g.a.a.b.b.a.f(6, this.LOd);
            }
            AppMethodBeat.o(209758);
            return r;
        } else if (i2 == 2) {
            ...
            switch (intValue) {
                ...
                case 2:
                    ...
                    return 0;
                case 3:
                    coa.twG = aVar3.UbS.zl();
                    AppMethodBeat.o(209758);
                    return 0;
                case 4:
                    coa.opType = aVar3.UbS.zi();
                    AppMethodBeat.o(209758);
                    return 0;
                case 5:
                    coa.tsR = aVar3.UbS.zl();
                    AppMethodBeat.o(209758);
                    return 0;
                case 6:
                    coa.LOd = aVar3.UbS.readString();
                    AppMethodBeat.o(209758);
                    return 0;
                default:
                    AppMethodBeat.o(209758);
