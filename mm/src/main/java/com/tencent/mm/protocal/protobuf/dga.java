...
public final class dga extends dpc {
    public String HuS;
    public int pTZ;
    public String pUa;
            ...
            switch (intValue) {
                case 1:
                    ...
                    for (int i3 = 0; i3 < size; i3++) {
                        ...
                        dga.BaseResponse = baseResponse;
                    }
                    AppMethodBeat.o(200221);
                    return 0;
                case 2:
                    dga.pTZ = aVar3.UbS.zi();
                    AppMethodBeat.o(200221);
                    return 0;
                case 3:
                    dga.pUa = aVar3.UbS.readString();
                    AppMethodBeat.o(200221);
                    return 0;
                case 100:
                    dga.HuS = aVar3.UbS.readString();
                    AppMethodBeat.o(200221);
                    return 0;
                default:
                    AppMethodBeat.o(200221);
