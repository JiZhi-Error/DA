...
public final class bpx extends dop {
    ...
    public final int op(int i2, Object... objArr) {
        ...
        if (i2 == 0) {
            ...
            int bu = nh + g.a.a.b.b.a.bu(3, this.KQy);
            if (this.oTI != null) {
                bu += g.a.a.b.b.a.f(4, this.oTI);
            }
            if (this.UserName != null) {
            ...
            switch (intValue) {
                ...
                case 2:
                    ...
                    for (int i4 = 0; i4 < size2; i4++) {
                        ...
                        bpx.KPW = sKBuiltinBuffer_t;
                    }
                    AppMethodBeat.o(232373);
                    return 0;
                case 3:
                    bpx.KQy = aVar3.UbS.zi();
                    AppMethodBeat.o(232373);
                    return 0;
                case 4:
                    bpx.oTI = aVar3.UbS.readString();
                    AppMethodBeat.o(232373);
                    return 0;
                case 5:
                    bpx.UserName = aVar3.UbS.readString();
                    AppMethodBeat.o(232373);
                    return 0;
                default:
                    AppMethodBeat.o(232373);
