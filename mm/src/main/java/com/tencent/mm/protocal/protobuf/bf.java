    ...
    public final int op(int i2, Object... objArr) {
        ...
        if (i2 == 0) {
            ...
            switch (((Integer) objArr[2]).intValue()) {
                case 1:
                    bfVar.fuJ = aVar3.UbS.readString();
                    AppMethodBeat.o(91341);
                    return 0;
                case 2:
                    bfVar.fuK = aVar3.UbS.readString();
                    AppMethodBeat.o(91341);
                    return 0;
                case 3:
                    bfVar.latitude = Double.longBitsToDouble(aVar3.UbS.zn());
                    AppMethodBeat.o(91341);
                    return 0;
                case 4:
                    bfVar.longitude = Double.longBitsToDouble(aVar3.UbS.zn());
                    AppMethodBeat.o(91341);
                    return 0;
                case 5:
                    bfVar.KEC = aVar3.UbS.zl();
                    AppMethodBeat.o(91341);
                    return 0;
                case 6:
                    bfVar.KED = aVar3.UbS.readString();
                    AppMethodBeat.o(91341);
                    return 0;
                case 7:
                    bfVar.KEE = aVar3.UbS.readString();
                    AppMethodBeat.o(91341);
                    return 0;
                case 8:
                    bfVar.KEF = aVar3.UbS.readString();
                    AppMethodBeat.o(91341);
                    return 0;
                case 9:
                    bfVar.KEG = aVar3.UbS.readString();
                    AppMethodBeat.o(91341);
                    return 0;
                case 10:
                    bfVar.KEH = aVar3.UbS.readString();
                    AppMethodBeat.o(91341);
                    return 0;
                default:
                    AppMethodBeat.o(91341);
