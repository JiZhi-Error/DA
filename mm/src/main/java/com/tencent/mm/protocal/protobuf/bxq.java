...
public final class bxq extends dop {
    ...
    public final int op(int i2, Object... objArr) {
        ...
        if (i2 == 0) {
            ...
            int bu = nh + g.a.a.b.b.a.bu(3, this.Mdo);
            if (this.KPW != null) {
                bu += g.a.a.a.nh(4, this.KPW.computeSize());
            }
            AppMethodBeat.o(32293);
            return bu;
        } else if (i2 == 2) {
            ...
            switch (intValue) {
                case 1:
                    ...
                    for (int i3 = 0; i3 < size; i3++) {
                        ...
                        bxq.BaseRequest = jrVar;
                    }
                    AppMethodBeat.o(32293);
                    return 0;
                case 2:
                    bxq.UserName = aVar3.UbS.readString();
                    AppMethodBeat.o(32293);
                    return 0;
                case 3:
                    bxq.Mdo = aVar3.UbS.zi();
                    AppMethodBeat.o(32293);
                    return 0;
                case 4:
