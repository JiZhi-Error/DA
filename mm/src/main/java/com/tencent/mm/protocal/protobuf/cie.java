...
public final class cie extends dop {
    public String KDQ;
    public long count;
    public long hyH;
    ...
    public final int op(int i2, Object... objArr) {
        ...
        if (i2 == 0) {
            ...
            int r = nh + g.a.a.b.b.a.r(4, this.count);
            AppMethodBeat.o(207493);
            return r;
        } else if (i2 == 2) {
            ...
            switch (intValue) {
                case 1:
                    ...
                    for (int i3 = 0; i3 < size; i3++) {
                        ...
                        cie.BaseRequest = jrVar;
                    }
                    AppMethodBeat.o(207493);
                    return 0;
                case 2:
                    cie.hyH = aVar3.UbS.zl();
                    AppMethodBeat.o(207493);
                    return 0;
                case 3:
                    cie.KDQ = aVar3.UbS.readString();
                    AppMethodBeat.o(207493);
                    return 0;
                case 4:
                    cie.count = aVar3.UbS.zl();
                    AppMethodBeat.o(207493);
                    return 0;
                default:
                    AppMethodBeat.o(207493);
