...
public final class xn extends dop {
    public String KBt;
    public String dNI;
    public String qcM;
            ...
            switch (intValue) {
                case 1:
                    ...
                    for (int i3 = 0; i3 < size; i3++) {
                        ...
                        xnVar.BaseRequest = jrVar;
                    }
                    AppMethodBeat.o(194539);
                    return 0;
                case 2:
                    xnVar.dNI = aVar3.UbS.readString();
                    AppMethodBeat.o(194539);
                    return 0;
                case 3:
                    xnVar.KBt = aVar3.UbS.readString();
                    AppMethodBeat.o(194539);
                    return 0;
                case 4:
                    xnVar.qcM = aVar3.UbS.readString();
                    AppMethodBeat.o(194539);
                    return 0;
                case 5:
                    xnVar.signature = aVar3.UbS.readString();
                    AppMethodBeat.o(194539);
                    return 0;
                default:
                    AppMethodBeat.o(194539);
