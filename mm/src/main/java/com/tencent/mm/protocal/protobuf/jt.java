...
public final class jt extends dpc {
    public LinkedList<xw> oTA = new LinkedList<>();
    public int oTz;
            ...
            switch (intValue) {
                ...
                case 3:
                    ...
                    for (int i4 = 0; i4 < size2; i4++) {
                        ...
                        for (boolean z2 = true; z2; z2 = xwVar.populateBuilderWithField(aVar5, xwVar, dpc.getNextFieldNumber(aVar5))) {
                        }
                        jtVar.oTA.add(xwVar);
                    }
                    AppMethodBeat.o(223883);
