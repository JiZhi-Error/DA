...
public final class aqd extends dpc {
    ...
    public final int op(int i2, Object... objArr) {
        ...
        if (i2 == 0) {
            ...
            if (this.LCg != null) {
                aVar.ni(4, this.LCg.computeSize());
            ...
            if (this.LCe != null) {
                nh += g.a.a.a.nh(2, this.LCe.computeSize());
            }
            if (this.LCf != null) {
                nh += g.a.a.b.b.a.f(3, this.LCf);
            }
            if (this.LCg != null) {
                nh += g.a.a.a.nh(4, this.LCg.computeSize());
            }
            AppMethodBeat.o(209371);
            return nh;
        } else if (i2 == 2) {
            ...
            switch (intValue) {
                ...
                case 2:
                    ...
                    for (int i4 = 0; i4 < size2; i4++) {
                        ...
                        aqd.LCe = finderObject;
                    }
                    AppMethodBeat.o(209371);
                    return 0;
                case 3:
                    aqd.LCf = aVar3.UbS.readString();
                    AppMethodBeat.o(209371);
                    return 0;
                case 4:
