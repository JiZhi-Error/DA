...
public final class cs extends dop {
    ...
    public final int op(int i2, Object... objArr) {
        ...
        if (i2 == 0) {
            ...
            int bu = nh + g.a.a.b.b.a.bu(5, this.KGS);
            if (this.KGT != null) {
                bu += g.a.a.b.b.a.f(6, this.KGT);
            }
            if (this.KGU != null) {
            ...
            switch (intValue) {
                case 1:
                    ...
                    for (int i3 = 0; i3 < size; i3++) {
                        ...
                        csVar.BaseRequest = jrVar;
                    }
                    AppMethodBeat.o(101791);
                    return 0;
                case 2:
                    csVar.gsq = aVar3.UbS.zi();
                    AppMethodBeat.o(101791);
                    return 0;
                case 3:
                ...
                case 4:
                    ...
                    return 0;
                case 5:
                    csVar.KGS = aVar3.UbS.zi();
                    AppMethodBeat.o(101791);
                    return 0;
                case 6:
                    csVar.KGT = aVar3.UbS.readString();
                    AppMethodBeat.o(101791);
                    return 0;
                case 7:
