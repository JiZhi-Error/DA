...
public final class bsl extends dpc {
    public String HPH;
    public boolean HPI;
    public int dDN;
    public String qwn;
            ...
            switch (intValue) {
                case 1:
                    ...
                    for (int i3 = 0; i3 < size; i3++) {
                        ...
                        bsl.BaseResponse = baseResponse;
                    }
                    AppMethodBeat.o(91503);
                    return 0;
                case 2:
                    bsl.dDN = aVar3.UbS.zi();
                    AppMethodBeat.o(91503);
                    return 0;
                case 3:
                    bsl.qwn = aVar3.UbS.readString();
                    AppMethodBeat.o(91503);
                    return 0;
                case 4:
                    bsl.HPH = aVar3.UbS.readString();
                    AppMethodBeat.o(91503);
                    return 0;
                case 5:
                    bsl.HPI = aVar3.UbS.yZ();
                    AppMethodBeat.o(91503);
                    return 0;
                default:
                    AppMethodBeat.o(91503);
