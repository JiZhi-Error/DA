...
public final class blz extends dop {
    public int Leq;
    public int Ler;
            ...
            switch (intValue) {
                case 1:
                    ...
                    for (int i3 = 0; i3 < size; i3++) {
                        ...
                        blz.BaseRequest = jrVar;
                    }
                    AppMethodBeat.o(201337);
                    return 0;
                case 2:
                    blz.offset = aVar3.UbS.zi();
                    AppMethodBeat.o(201337);
                    return 0;
                case 3:
                    blz.Ler = aVar3.UbS.zi();
                    AppMethodBeat.o(201337);
                    return 0;
                case 4:
                    blz.latitude = Double.longBitsToDouble(aVar3.UbS.zn());
                    AppMethodBeat.o(201337);
                    return 0;
                case 5:
                    blz.longitude = Double.longBitsToDouble(aVar3.UbS.zn());
                    AppMethodBeat.o(201337);
                    return 0;
                case 6:
                    blz.scene = aVar3.UbS.zi();
                    AppMethodBeat.o(201337);
                    return 0;
                case 7:
                    blz.Leq = aVar3.UbS.zi();
                    AppMethodBeat.o(201337);
                    return 0;
                default:
                    AppMethodBeat.o(201337);
