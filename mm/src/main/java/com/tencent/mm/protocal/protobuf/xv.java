...
public final class xv extends dop {
    public int KKA;
    public long KMg;
    public String KMh;
    public String LbJ;
            ...
            switch (intValue) {
                case 1:
                    ...
                    for (int i3 = 0; i3 < size; i3++) {
                        ...
                        xvVar.BaseRequest = jrVar;
                    }
                    AppMethodBeat.o(32157);
                    return 0;
                case 2:
                    xvVar.xNH = aVar3.UbS.readString();
                    AppMethodBeat.o(32157);
                    return 0;
                case 3:
                    xvVar.xNG = aVar3.UbS.readString();
                    AppMethodBeat.o(32157);
                    return 0;
                case 4:
                    xvVar.KMg = aVar3.UbS.zl();
                    AppMethodBeat.o(32157);
                    return 0;
                case 5:
                    xvVar.LbJ = aVar3.UbS.readString();
                    AppMethodBeat.o(32157);
                    return 0;
                case 6:
                    xvVar.xuB = aVar3.UbS.readString();
                    AppMethodBeat.o(32157);
                    return 0;
                case 7:
                    xvVar.KKA = aVar3.UbS.zi();
                    AppMethodBeat.o(32157);
                    return 0;
                case 8:
                    xvVar.KMh = aVar3.UbS.readString();
                    AppMethodBeat.o(32157);
                    return 0;
                case 9:
                    xvVar.xuz = aVar3.UbS.readString();
                    AppMethodBeat.o(32157);
                    return 0;
                default:
                    AppMethodBeat.o(32157);
