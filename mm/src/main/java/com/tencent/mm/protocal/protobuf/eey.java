...
public final class eey extends dop {
    public fdh MeK;
    public fdi MeL;
    public fdj MeM;
    public ffd NeT;
    ...
    public final int op(int i2, Object... objArr) {
        ...
        if (i2 == 0) {
            ...
            if (this.NeT != null) {
                aVar.ni(8, this.NeT.computeSize());
                this.NeT.writeFields(aVar);
            }
            ...
            if (this.NeT != null) {
                nh += g.a.a.a.nh(8, this.NeT.computeSize());
            }
            AppMethodBeat.o(50115);
            return nh;
        } else if (i2 == 2) {
            ...
            switch (intValue) {
                case 1:
                    ...
                    for (int i3 = 0; i3 < size; i3++) {
                        ...
                        eey.BaseRequest = jrVar;
                    }
                    AppMethodBeat.o(50115);
                    return 0;
                case 2:
                    eey.jfi = aVar3.UbS.readString();
                    AppMethodBeat.o(50115);
                    return 0;
                case 3:
                ...
                case 8:
                    ...
                    for (int i7 = 0; i7 < size5; i7++) {
                        ...
                        for (boolean z5 = true; z5; z5 = ffd.populateBuilderWithField(aVar8, ffd, dop.getNextFieldNumber(aVar8))) {
                        }
                        eey.NeT = ffd;
                    }
                    AppMethodBeat.o(50115);
