...
public final class dry extends dpc {
    ...
    public final int op(int i2, Object... objArr) {
        ...
        if (i2 == 0) {
            ...
            if (this.BaseResponse == null) {
                ...
                b bVar2 = new b("Not all required fields were included: SearchResult");
                AppMethodBeat.o(104835);
                throw bVar2;
            } else {
                if (this.BaseResponse != null) {
            ...
            if (this.MUB != null) {
                nh += g.a.a.b.b.a.f(2, this.MUB);
            }
            if (this.LUY != null) {
                nh += g.a.a.a.nh(3, this.LUY.computeSize());
            }
            int r = nh + g.a.a.b.b.a.r(4, this.LVb);
            AppMethodBeat.o(104835);
            return r;
        } else if (i2 == 2) {
            ...
            if (this.BaseResponse == null) {
                ...
                b bVar4 = new b("Not all required fields were included: SearchResult");
                AppMethodBeat.o(104835);
                throw bVar4;
            } else {
                AppMethodBeat.o(104835);
            ...
            switch (intValue) {
                case 1:
                    ...
                    for (int i3 = 0; i3 < size; i3++) {
                        ...
                        dry.BaseResponse = baseResponse;
                    }
                    AppMethodBeat.o(104835);
                    return 0;
                case 2:
                    dry.MUB = aVar3.UbS.readString();
                    AppMethodBeat.o(104835);
                    return 0;
                case 3:
                    ...
                    for (int i4 = 0; i4 < size2; i4++) {
                        ...
                        dry.LUY = sKBuiltinBuffer_t;
                    }
                    AppMethodBeat.o(104835);
                    return 0;
                case 4:
                    dry.LVb = aVar3.UbS.zl();
                    AppMethodBeat.o(104835);
                    return 0;
                default:
                    AppMethodBeat.o(104835);
