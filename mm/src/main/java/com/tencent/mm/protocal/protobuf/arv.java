...
public final class arv extends dop {
    public aov LBM;
    public b lastBuffer;
    ...
    public final int op(int i2, Object... objArr) {
        ...
        if (i2 == 0) {
            ...
            int bu = nh + g.a.a.b.b.a.bu(4, this.objectType);
            if (this.lastBuffer != null) {
            ...
            switch (intValue) {
                ...
                case 2:
                    ...
                    return 0;
                case 3:
                    arv.username = aVar3.UbS.readString();
                    AppMethodBeat.o(209402);
                    return 0;
                case 4:
                    arv.objectType = aVar3.UbS.zi();
                    AppMethodBeat.o(209402);
                    return 0;
                case 5:
                    arv.lastBuffer = aVar3.UbS.hPo();
                    AppMethodBeat.o(209402);
                    return 0;
                default:
                    AppMethodBeat.o(209402);
