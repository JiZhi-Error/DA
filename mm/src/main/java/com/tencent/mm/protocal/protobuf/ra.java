...
public final class ra extends dpc {
    public sh KXT;
    public int pTZ;
    public String pUa;
            ...
            switch (intValue) {
                case 1:
                    ...
                    for (int i3 = 0; i3 < size; i3++) {
                        ...
                        raVar.BaseResponse = baseResponse;
                    }
                    AppMethodBeat.o(91366);
                    return 0;
                case 2:
                    raVar.pTZ = aVar3.UbS.zi();
                    AppMethodBeat.o(91366);
                    return 0;
                case 3:
                    raVar.pUa = aVar3.UbS.readString();
                    AppMethodBeat.o(91366);
                    return 0;
                case 4:
                    ...
                    for (int i4 = 0; i4 < size2; i4++) {
                        ...
                        for (boolean z2 = true; z2; z2 = shVar.populateBuilderWithField(aVar5, shVar, dpc.getNextFieldNumber(aVar5))) {
                        }
                        raVar.KXT = shVar;
                    }
                    AppMethodBeat.o(91366);
