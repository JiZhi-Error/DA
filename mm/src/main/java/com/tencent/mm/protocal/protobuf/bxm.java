...
public final class bxm extends dop {
    ...
    public final int op(int i2, Object... objArr) {
        ...
        if (i2 == 0) {
            ...
            int nh = (this.BaseRequest != null ? g.a.a.a.nh(1, this.BaseRequest.computeSize()) + 0 : 0) + g.a.a.b.b.a.bu(2, this.Mdl);
            if (this.Mdm != null) {
                nh += g.a.a.b.b.a.f(3, this.Mdm);
            }
            if (this.KPW != null) {
            ...
            switch (intValue) {
                case 1:
                    ...
                    for (int i3 = 0; i3 < size; i3++) {
                        ...
                        bxm.BaseRequest = jrVar;
                    }
                    AppMethodBeat.o(32289);
                    return 0;
                case 2:
                    bxm.Mdl = aVar3.UbS.zi();
                    AppMethodBeat.o(32289);
                    return 0;
                case 3:
                    bxm.Mdm = aVar3.UbS.readString();
                    AppMethodBeat.o(32289);
                    return 0;
                case 4:
