...
public final class on extends dop {
    public String KUs;
            ...
            switch (intValue) {
                case 1:
                    ...
                    for (int i3 = 0; i3 < size; i3++) {
                        ...
                        onVar.BaseRequest = jrVar;
                    }
                    AppMethodBeat.o(124431);
                    return 0;
                case 2:
                    onVar.ProductID = aVar3.UbS.readString();
                    AppMethodBeat.o(124431);
                    return 0;
                case 3:
                    onVar.Scene = aVar3.UbS.zi();
                    AppMethodBeat.o(124431);
                    return 0;
                case 4:
                    onVar.KUs = aVar3.UbS.readString();
                    AppMethodBeat.o(124431);
                    return 0;
                default:
                    AppMethodBeat.o(124431);
