...
public final class ie extends dpc {
    ...
    public final int op(int i2, Object... objArr) {
        ...
        if (i2 == 0) {
            ...
            if (this.KLq != null) {
                aVar.ni(2, this.KLq.computeSize());
                this.KLq.writeFields(aVar);
            }
            if (this.KLr != null) {
                aVar.ni(3, this.KLr.computeSize());
            ...
            if (this.KLq != null) {
                nh += g.a.a.a.nh(2, this.KLq.computeSize());
            }
            if (this.KLr != null) {
                nh += g.a.a.a.nh(3, this.KLr.computeSize());
            }
            AppMethodBeat.o(133151);
            return nh;
        } else if (i2 == 2) {
            ...
            switch (intValue) {
                case 1:
                    ...
                    for (int i3 = 0; i3 < size; i3++) {
                        ...
                        ieVar.BaseResponse = baseResponse;
                    }
                    AppMethodBeat.o(133151);
                    return 0;
                case 2:
