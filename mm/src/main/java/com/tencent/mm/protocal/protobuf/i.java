...
public final class i extends dpc {
    ...
    public final int op(int i2, Object... objArr) {
        ...
        if (i2 == 0) {
            ...
            if (this.KBD != null) {
                aVar.ni(6, this.KBD.computeSize());
                this.KBD.writeFields(aVar);
            }
            if (this.KBE != null) {
                aVar.ni(7, this.KBE.computeSize());
            ...
            if (this.KBu != null) {
                nh += g.a.a.b.b.a.f(5, this.KBu);
            }
            if (this.KBD != null) {
                nh += g.a.a.a.nh(6, this.KBD.computeSize());
            }
            if (this.KBE != null) {
                nh += g.a.a.a.nh(7, this.KBE.computeSize());
            }
            AppMethodBeat.o(200186);
            return nh;
        } else if (i2 == 2) {
            ...
            switch (intValue) {
                case 1:
                    ...
                    return 0;
                case 2:
                    iVar.dDN = aVar3.UbS.zi();
                    AppMethodBeat.o(200186);
                    return 0;
                case 3:
                    iVar.qwn = aVar3.UbS.readString();
                    AppMethodBeat.o(200186);
                    return 0;
                case 4:
                    iVar.KBs = aVar3.UbS.readString();
                    AppMethodBeat.o(200186);
                    return 0;
                case 5:
                    iVar.KBu = aVar3.UbS.readString();
                    AppMethodBeat.o(200186);
                    return 0;
                case 6:
