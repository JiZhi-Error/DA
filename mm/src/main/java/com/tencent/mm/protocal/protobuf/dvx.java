...
public final class dvx extends dpc {
    public dis KTz;
    public og LTl;
    ...
    public final int op(int i2, Object... objArr) {
        ...
        if (i2 == 0) {
            ...
            if (this.BaseResponse == null) {
                ...
                b bVar3 = new b("Not all required fields were included: attr");
                AppMethodBeat.o(124552);
                throw bVar3;
            } else {
                if (this.BaseResponse != null) {
                ...
                if (this.LTl != null) {
                    aVar.ni(3, this.LTl.computeSize());
            ...
            if (this.LTl != null) {
                nh += g.a.a.a.nh(3, this.LTl.computeSize());
            }
            AppMethodBeat.o(124552);
            return nh;
        } else if (i2 == 2) {
            ...
            if (this.BaseResponse == null) {
                ...
                b bVar5 = new b("Not all required fields were included: qy_base_resp");
                AppMethodBeat.o(124552);
                throw bVar5;
            } else if (this.LTl == null) {
                b bVar6 = new b("Not all required fields were included: attr");
                AppMethodBeat.o(124552);
                throw bVar6;
            } else {
                AppMethodBeat.o(124552);
            ...
            switch (intValue) {
                ...
                case 3:
                    ...
                    for (int i5 = 0; i5 < size3; i5++) {
                        ...
                        for (boolean z3 = true; z3; z3 = ogVar.populateBuilderWithField(aVar6, ogVar, dpc.getNextFieldNumber(aVar6))) {
                        }
                        dvx.LTl = ogVar;
                    }
                    AppMethodBeat.o(124552);
