...
public final class bzh extends dpc {
    public fcd Ljo;
    ...
    public final int op(int i2, Object... objArr) {
        ...
        if (i2 == 0) {
            ...
            int c2 = nh + g.a.a.a.c(3, 8, this.MeZ);
            AppMethodBeat.o(225292);
            return c2;
        } else if (i2 == 2) {
            this.MeZ.clear();
            ...
            switch (intValue) {
                ...
                case 3:
                    ...
                    for (int i5 = 0; i5 < size3; i5++) {
                        ...
                        for (boolean z3 = true; z3; z3 = fdy.populateBuilderWithField(aVar6, fdy, dpc.getNextFieldNumber(aVar6))) {
                        }
                        bzh.MeZ.add(fdy);
                    }
                    AppMethodBeat.o(225292);
