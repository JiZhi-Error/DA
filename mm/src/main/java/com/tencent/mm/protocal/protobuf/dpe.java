...
public final class dpe extends a {
    public String Desc;
    ...
    public final int op(int i2, Object... objArr) {
        ...
        if (i2 == 0) {
            ...
            dpe dpe = (dpe) objArr[1];
            switch (((Integer) objArr[2]).intValue()) {
                case 1:
                    dpe.MEq = aVar3.UbS.readString();
                    AppMethodBeat.o(117904);
                    return 0;
                case 2:
                    dpe.Title = aVar3.UbS.readString();
                    AppMethodBeat.o(117904);
                    return 0;
                case 3:
                    dpe.Desc = aVar3.UbS.readString();
                    AppMethodBeat.o(117904);
                    return 0;
                case 4:
                    dpe.IconUrl = aVar3.UbS.readString();
                    AppMethodBeat.o(117904);
                    return 0;
                case 5:
                    dpe.MEr = aVar3.UbS.readString();
                    AppMethodBeat.o(117904);
                    return 0;
                default:
                    AppMethodBeat.o(117904);
