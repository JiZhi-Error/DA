...
public class cen extends dpc {
    public cdz Mkb;
    public LinkedList<drc> Mkc = new LinkedList<>();
    ...
    public final int op(int i2, Object... objArr) {
        ...
        if (i2 == 0) {
            ...
            int c2 = nh + g.a.a.a.c(3, 8, this.Mkc);
            AppMethodBeat.o(123606);
            return c2;
        } else if (i2 == 2) {
            this.Mkc.clear();
            ...
            switch (intValue) {
                ...
                case 3:
                    ...
                    for (int i5 = 0; i5 < size3; i5++) {
                        ...
                        for (boolean z3 = true; z3; z3 = drc.populateBuilderWithField(aVar6, drc, dpc.getNextFieldNumber(aVar6))) {
                        }
                        cen.Mkc.add(drc);
                    }
                    AppMethodBeat.o(123606);
