...
public final class hf extends a {
    ...
    public final int op(int i2, Object... objArr) {
        ...
        if (i2 == 0) {
            ...
            if (this.KKP == null) {
                b bVar = new b("Not all required fields were included: MediaObj");
                AppMethodBeat.o(125713);
                throw bVar;
            }
            if (this.KKP != null) {
                aVar.ni(1, this.KKP.computeSize());
                this.KKP.writeFields(aVar);
            }
            AppMethodBeat.o(125713);
            return 0;
        } else if (i2 == 1) {
            int nh = this.KKP != null ? g.a.a.a.nh(1, this.KKP.computeSize()) + 0 : 0;
            AppMethodBeat.o(125713);
            return nh;
        } else if (i2 == 2) {
            ...
            if (this.KKP == null) {
                b bVar2 = new b("Not all required fields were included: MediaObj");
                AppMethodBeat.o(125713);
                throw bVar2;
            }
            AppMethodBeat.o(125713);
