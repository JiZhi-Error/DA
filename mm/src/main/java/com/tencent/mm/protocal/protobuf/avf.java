...
public final class avf extends dop {
    public String LAt;
    public aov LBM;
    public b LFp;
    public long hyH;
        ...
        if (i2 == 0) {
            ...
            switch (intValue) {
                ...
                case 4:
                    ...
                    return 0;
                case 5:
                    avf.hyH = aVar3.UbS.zl();
                    AppMethodBeat.o(209498);
                    return 0;
                case 6:
                    avf.object_id = aVar3.UbS.zl();
                    AppMethodBeat.o(209498);
                    return 0;
                case 7:
                    avf.object_nonce_id = aVar3.UbS.readString();
                    AppMethodBeat.o(209498);
                    return 0;
                case 8:
                    avf.scene = aVar3.UbS.zi();
                    AppMethodBeat.o(209498);
                    return 0;
                case 9:
                    avf.LAt = aVar3.UbS.readString();
                    AppMethodBeat.o(209498);
                    return 0;
                default:
                    AppMethodBeat.o(209498);
