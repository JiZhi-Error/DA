...
public final class dwn extends dpc {
    ...
    public final int op(int i2, Object... objArr) {
        ...
        if (i2 == 0) {
            ...
            if (this.KKZ != null) {
                aVar.ni(2, this.KKZ.computeSize());
            ...
            if (this.KKZ != null) {
                nh += g.a.a.a.nh(2, this.KKZ.computeSize());
            }
            AppMethodBeat.o(134258);
            return nh;
        } else if (i2 == 2) {
