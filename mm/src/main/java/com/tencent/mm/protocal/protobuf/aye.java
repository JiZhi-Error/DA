...
public final class aye extends dop {
    public aov LAI;
    ...
    public final int op(int i2, Object... objArr) {
        ...
        if (i2 == 0) {
            ...
            int c2 = nh + g.a.a.a.c(3, 8, this.LIs);
            AppMethodBeat.o(184200);
            return c2;
        } else if (i2 == 2) {
            this.LIs.clear();
            ...
            switch (intValue) {
                ...
                case 3:
                    ...
                    for (int i5 = 0; i5 < size3; i5++) {
                        ...
                        for (boolean z3 = true; z3; z3 = cmm.populateBuilderWithField(aVar6, cmm, dop.getNextFieldNumber(aVar6))) {
                        }
                        aye.LIs.add(cmm);
                    }
                    AppMethodBeat.o(184200);
