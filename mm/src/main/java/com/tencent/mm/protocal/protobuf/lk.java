...
public final class lk extends dpc {
            ...
            switch (intValue) {
                case 1:
                    ...
                    for (int i3 = 0; i3 < size; i3++) {
                        ...
                        lkVar.BaseResponse = baseResponse;
                    }
                    AppMethodBeat.o(127443);
                    return 0;
                case 2:
                    lkVar.oTz = aVar3.UbS.zi();
                    AppMethodBeat.o(127443);
                    return 0;
                case 3:
                    ...
                    for (int i4 = 0; i4 < size2; i4++) {
                        ...
                        for (boolean z2 = true; z2; z2 = eji.populateBuilderWithField(aVar5, eji, dpc.getNextFieldNumber(aVar5))) {
                        }
                        lkVar.oTA.add(eji);
                    }
                    AppMethodBeat.o(127443);
