...
public final class ffw extends dop {
    public String LAt;
    public aov LBM;
    public b LFp;
    public long hyH;
        ...
        if (i2 == 0) {
            ...
            switch (intValue) {
                ...
                case 4:
                    ...
                    return 0;
                case 5:
                    ffw.hyH = aVar3.UbS.zl();
                    AppMethodBeat.o(259326);
                    return 0;
                case 6:
                    ffw.object_id = aVar3.UbS.zl();
                    AppMethodBeat.o(259326);
                    return 0;
                case 7:
                    ffw.object_nonce_id = aVar3.UbS.readString();
                    AppMethodBeat.o(259326);
                    return 0;
                case 8:
                    ffw.scene = aVar3.UbS.zi();
                    AppMethodBeat.o(259326);
                    return 0;
                case 9:
                    ffw.LAt = aVar3.UbS.readString();
                    AppMethodBeat.o(259326);
                    return 0;
                default:
                    AppMethodBeat.o(259326);
