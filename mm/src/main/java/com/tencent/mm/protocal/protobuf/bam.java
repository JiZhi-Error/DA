...
public final class bam extends dop {
    public aov LAI;
    public String LAt;
    public b LFp;
    public long hyH;
        ...
        if (i2 == 0) {
            ...
            switch (intValue) {
                ...
                case 4:
                    ...
                    return 0;
                case 5:
                    bam.hyH = aVar3.UbS.zl();
                    AppMethodBeat.o(209635);
                    return 0;
                case 6:
                    bam.object_id = aVar3.UbS.zl();
                    AppMethodBeat.o(209635);
                    return 0;
                case 7:
                    bam.object_nonce_id = aVar3.UbS.readString();
                    AppMethodBeat.o(209635);
                    return 0;
                case 8:
                    bam.scene = aVar3.UbS.zi();
                    AppMethodBeat.o(209635);
                    return 0;
                case 9:
                    bam.LAt = aVar3.UbS.readString();
                    AppMethodBeat.o(209635);
                    return 0;
                default:
                    AppMethodBeat.o(209635);
