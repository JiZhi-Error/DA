...
public final class cnn extends dpc {
    public cng LIA;
    ...
    public final int op(int i2, Object... objArr) {
        ...
        if (i2 == 0) {
            ...
            if (this.contact != null) {
                aVar.ni(3, this.contact.computeSize());
            ...
            if (this.LIA != null) {
                nh += g.a.a.a.nh(2, this.LIA.computeSize());
            }
            if (this.contact != null) {
                nh += g.a.a.a.nh(3, this.contact.computeSize());
            }
            AppMethodBeat.o(209741);
            return nh;
        } else if (i2 == 2) {
            ...
            switch (intValue) {
                ...
                case 2:
                    ...
                    for (int i4 = 0; i4 < size2; i4++) {
                        ...
                        for (boolean z2 = true; z2; z2 = cng.populateBuilderWithField(aVar5, cng, dpc.getNextFieldNumber(aVar5))) {
                        }
                        cnn.LIA = cng;
                    }
                    AppMethodBeat.o(209741);
