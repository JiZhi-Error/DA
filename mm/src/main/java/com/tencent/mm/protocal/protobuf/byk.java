...
public final class byk extends dop {
            ...
            switch (intValue) {
                case 1:
                    ...
                    for (int i3 = 0; i3 < size; i3++) {
                        ...
                        byk.BaseRequest = jrVar;
                    }
                    AppMethodBeat.o(56252);
                    return 0;
                case 2:
                    byk.longitude = Double.longBitsToDouble(aVar3.UbS.zn());
                    AppMethodBeat.o(56252);
                    return 0;
                case 3:
                    byk.latitude = Double.longBitsToDouble(aVar3.UbS.zn());
                    AppMethodBeat.o(56252);
                    return 0;
                default:
                    AppMethodBeat.o(56252);
