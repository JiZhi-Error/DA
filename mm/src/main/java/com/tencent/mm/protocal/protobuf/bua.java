...
public final class bua extends dop {
    public b Buffer;
    public int Scene;
    ...
    public final int op(int i2, Object... objArr) {
        ...
        if (i2 == 0) {
            ...
            if (this.Buffer != null) {
                nh += g.a.a.b.b.a.b(3, this.Buffer);
            }
            AppMethodBeat.o(212277);
            return nh;
        } else if (i2 == 2) {
            ...
            switch (intValue) {
                case 1:
                    ...
                    for (int i3 = 0; i3 < size; i3++) {
                        ...
                        bua.BaseRequest = jrVar;
                    }
                    AppMethodBeat.o(212277);
                    return 0;
                case 2:
                    bua.Scene = aVar3.UbS.zi();
                    AppMethodBeat.o(212277);
                    return 0;
                case 3:
                    bua.Buffer = aVar3.UbS.hPo();
                    AppMethodBeat.o(212277);
                    return 0;
                default:
                    AppMethodBeat.o(212277);
