...
public final class ejb extends dop {
    public String FhU;
    public String hFF;
    public int scene;
            ...
            switch (intValue) {
                case 1:
                    ...
                    for (int i3 = 0; i3 < size; i3++) {
                        ...
                        ejb.BaseRequest = jrVar;
                    }
                    AppMethodBeat.o(129975);
                    return 0;
                case 2:
                    ejb.scene = aVar3.UbS.zi();
                    AppMethodBeat.o(129975);
                    return 0;
                case 3:
                    ejb.FhU = aVar3.UbS.readString();
                    AppMethodBeat.o(129975);
                    return 0;
                case 4:
                    ejb.hFF = aVar3.UbS.readString();
                    AppMethodBeat.o(129975);
                    return 0;
                default:
                    AppMethodBeat.o(129975);
