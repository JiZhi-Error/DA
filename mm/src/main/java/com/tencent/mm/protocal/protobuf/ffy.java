...
public final class ffy extends dop {
    public String LAt;
    public aov LBM;
    public b LFp;
    public long hyH;
        ...
        if (i2 == 0) {
            ...
            switch (intValue) {
                ...
                case 4:
                    ...
                    return 0;
                case 5:
                    ffy.hyH = aVar3.UbS.zl();
                    AppMethodBeat.o(259328);
                    return 0;
                case 6:
                    ffy.object_id = aVar3.UbS.zl();
                    AppMethodBeat.o(259328);
                    return 0;
                case 7:
                    ffy.object_nonce_id = aVar3.UbS.readString();
                    AppMethodBeat.o(259328);
                    return 0;
                case 8:
                    ffy.scene = aVar3.UbS.zi();
                    AppMethodBeat.o(259328);
                    return 0;
                case 9:
                    ffy.LAt = aVar3.UbS.readString();
                    AppMethodBeat.o(259328);
                    return 0;
                default:
                    AppMethodBeat.o(259328);
