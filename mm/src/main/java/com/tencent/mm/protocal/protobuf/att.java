...
public final class att extends dpc {
    public LinkedList<bdk> LDz = new LinkedList<>();
            ...
            switch (intValue) {
                ...
                case 2:
                    ...
                    for (int i4 = 0; i4 < size2; i4++) {
                        ...
                        for (boolean z2 = true; z2; z2 = bdk.populateBuilderWithField(aVar5, bdk, dpc.getNextFieldNumber(aVar5))) {
                        }
                        att.LDz.add(bdk);
                    }
                    AppMethodBeat.o(209462);
