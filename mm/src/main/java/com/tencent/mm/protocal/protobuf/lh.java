...
public final class lh extends dop {
    public LinkedList<efw> KOw = new LinkedList<>();
    ...
    public final int op(int i2, Object... objArr) {
        ...
        if (i2 == 0) {
            ...
            int nh = (this.BaseRequest != null ? g.a.a.a.nh(1, this.BaseRequest.computeSize()) + 0 : 0) + g.a.a.a.c(2, 8, this.KOw);
            AppMethodBeat.o(153267);
            return nh;
        } else if (i2 == 2) {
            this.KOw.clear();
