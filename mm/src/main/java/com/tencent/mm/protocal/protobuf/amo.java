    ...
    public final int op(int i2, Object... objArr) {
        ...
        if (i2 == 0) {
            ...
            switch (((Integer) objArr[2]).intValue()) {
                case 1:
                    amo.iyZ = aVar3.UbS.readString();
                    AppMethodBeat.o(127460);
                    return 0;
                case 2:
                    amo.LxJ = aVar3.UbS.zi();
                    AppMethodBeat.o(127460);
                    return 0;
                case 3:
                    amo.izc = aVar3.UbS.readString();
                    AppMethodBeat.o(127460);
                    return 0;
                case 4:
                    amo.izd = aVar3.UbS.readString();
                    AppMethodBeat.o(127460);
                    return 0;
                case 5:
                    amo.izb = aVar3.UbS.readString();
                    AppMethodBeat.o(127460);
                    return 0;
                case 6:
                    amo.ize = aVar3.UbS.readString();
                    AppMethodBeat.o(127460);
                    return 0;
                case 7:
                    amo.izf = aVar3.UbS.readString();
                    AppMethodBeat.o(127460);
                    return 0;
                case 8:
                    amo.izg = aVar3.UbS.readString();
                    AppMethodBeat.o(127460);
                    return 0;
                default:
                    AppMethodBeat.o(127460);
