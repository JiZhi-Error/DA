...
public final class bxr extends dpc {
    public ccb KQj;
    public qy KQk;
    public ctb KQl;
    public String Mdp;
    ...
    public final int op(int i2, Object... objArr) {
        ...
        if (i2 == 0) {
            ...
            if (this.KQl != null) {
                aVar.ni(5, this.KQl.computeSize());
            ...
            if (this.KQl != null) {
                nh += g.a.a.a.nh(5, this.KQl.computeSize());
            }
            AppMethodBeat.o(32294);
            return nh;
        } else if (i2 == 2) {
            ...
            switch (intValue) {
                case 1:
                    ...
                    for (int i3 = 0; i3 < size; i3++) {
                        ...
                        bxr.BaseResponse = baseResponse;
                    }
                    AppMethodBeat.o(32294);
                    return 0;
                case 2:
                    bxr.Mdp = aVar3.UbS.readString();
                    AppMethodBeat.o(32294);
                    return 0;
                case 3:
