...
public final class els extends dpc {
    public dis KTz;
    public nt LPp;
            ...
            switch (intValue) {
                ...
                case 3:
                    ...
                    for (int i5 = 0; i5 < size3; i5++) {
                        ...
                        for (boolean z3 = true; z3; z3 = ntVar.populateBuilderWithField(aVar6, ntVar, dpc.getNextFieldNumber(aVar6))) {
                        }
                        els.LPp = ntVar;
                    }
                    AppMethodBeat.o(124573);
