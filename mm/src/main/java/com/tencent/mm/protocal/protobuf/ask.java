...
public final class ask extends dpc {
    public b LDs;
    ...
    public final int op(int i2, Object... objArr) {
        ...
        if (i2 == 0) {
            ...
            if (this.preloadInfo != null) {
                aVar.ni(5, this.preloadInfo.computeSize());
            ...
            if (this.preloadInfo != null) {
                bu += g.a.a.a.nh(5, this.preloadInfo.computeSize());
            }
            AppMethodBeat.o(168984);
            return bu;
        } else if (i2 == 2) {
            ...
            switch (intValue) {
                ...
                case 2:
                    ...
                    for (int i4 = 0; i4 < size2; i4++) {
                        ...
                        ask.object.add(finderObject);
                    }
                    AppMethodBeat.o(168984);
                    return 0;
                case 3:
                    ask.LDs = aVar3.UbS.hPo();
                    AppMethodBeat.o(168984);
                    return 0;
                case 4:
                    ask.tUC = aVar3.UbS.zi();
                    AppMethodBeat.o(168984);
                    return 0;
                case 5:
