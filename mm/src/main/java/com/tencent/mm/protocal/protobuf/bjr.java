...
public final class bjr extends dop {
    public String KTt;
    public int LTj;
    public int LTk;
    ...
    public final int op(int i2, Object... objArr) {
        ...
        if (i2 == 0) {
            ...
            int bu = nh + g.a.a.b.b.a.bu(3, this.LTj) + g.a.a.b.b.a.bu(4, this.LTk);
            AppMethodBeat.o(124504);
            return bu;
        } else if (i2 == 2) {
            ...
            switch (intValue) {
                case 1:
                    ...
                    for (int i3 = 0; i3 < size; i3++) {
                        ...
                        bjr.BaseRequest = jrVar;
                    }
                    AppMethodBeat.o(124504);
                    return 0;
                case 2:
                    bjr.KTt = aVar3.UbS.readString();
                    AppMethodBeat.o(124504);
                    return 0;
                case 3:
                    bjr.LTj = aVar3.UbS.zi();
                    AppMethodBeat.o(124504);
                    return 0;
                case 4:
                    bjr.LTk = aVar3.UbS.zi();
                    AppMethodBeat.o(124504);
                    return 0;
                default:
                    AppMethodBeat.o(124504);
