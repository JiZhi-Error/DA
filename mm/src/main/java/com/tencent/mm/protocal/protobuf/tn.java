...
public final class tn extends dop {
    public String KKR;
    public String Lcb;
    public bf Lcc;
    ...
    public final int op(int i2, Object... objArr) {
        ...
        if (i2 == 0) {
            ...
            if (this.Lcb != null) {
                nh += g.a.a.b.b.a.f(2, this.Lcb);
            }
            if (this.KKR != null) {
                nh += g.a.a.b.b.a.f(3, this.KKR);
            }
            if (this.Lcc != null) {
            ...
            switch (intValue) {
                case 1:
                    ...
                    for (int i3 = 0; i3 < size; i3++) {
                        ...
                        tnVar.BaseRequest = jrVar;
                    }
                    AppMethodBeat.o(91392);
                    return 0;
                case 2:
                    tnVar.Lcb = aVar3.UbS.readString();
                    AppMethodBeat.o(91392);
                    return 0;
                case 3:
                    tnVar.KKR = aVar3.UbS.readString();
                    AppMethodBeat.o(91392);
                    return 0;
                case 4:
