...
public final class dj extends dpc {
    ...
    public final int op(int i2, Object... objArr) {
        ...
        if (i2 == 0) {
            ...
            int nh = (this.BaseResponse != null ? g.a.a.a.nh(1, this.BaseResponse.computeSize()) + 0 : 0) + g.a.a.a.c(2, 8, this.KHx);
            if (this.KHy != null) {
                nh += g.a.a.b.b.a.f(3, this.KHy);
            }
            AppMethodBeat.o(152486);
            return nh;
        } else if (i2 == 2) {
            ...
            switch (intValue) {
                case 1:
                    ...
                    for (int i3 = 0; i3 < size; i3++) {
                        ...
                        djVar.BaseResponse = baseResponse;
                    }
                    AppMethodBeat.o(152486);
                    return 0;
                case 2:
                    ...
                    return 0;
                case 3:
                    djVar.KHy = aVar3.UbS.readString();
                    AppMethodBeat.o(152486);
                    return 0;
                default:
                    AppMethodBeat.o(152486);
