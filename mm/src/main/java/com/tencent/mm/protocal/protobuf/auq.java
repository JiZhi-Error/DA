...
public final class auq extends dop {
    public String LAt;
    public aov LBM;
    public b LFp;
    public long hyH;
        ...
        if (i2 == 0) {
            ...
            switch (intValue) {
                ...
                case 4:
                    ...
                    return 0;
                case 5:
                    auq.hyH = aVar3.UbS.zl();
                    AppMethodBeat.o(209482);
                    return 0;
                case 6:
                    auq.object_id = aVar3.UbS.zl();
                    AppMethodBeat.o(209482);
                    return 0;
                case 7:
                    auq.object_nonce_id = aVar3.UbS.readString();
                    AppMethodBeat.o(209482);
                    return 0;
                case 8:
                    auq.scene = aVar3.UbS.zi();
                    AppMethodBeat.o(209482);
                    return 0;
                case 9:
                    auq.LAt = aVar3.UbS.readString();
                    AppMethodBeat.o(209482);
                    return 0;
                default:
                    AppMethodBeat.o(209482);
