...
public final class lw extends dpc {
    public ddb KPx;
    public cxc KPy;
    public int pTZ;
    public String pUa;
    ...
    public final int op(int i2, Object... objArr) {
        ...
        if (i2 == 0) {
            ...
            if (this.KPy != null) {
                aVar.ni(7, this.KPy.computeSize());
            ...
            if (this.KPx != null) {
                nh += g.a.a.a.nh(6, this.KPx.computeSize());
            }
            if (this.KPy != null) {
                nh += g.a.a.a.nh(7, this.KPy.computeSize());
            }
            AppMethodBeat.o(72423);
            return nh;
        } else if (i2 == 2) {
            ...
            switch (intValue) {
                case 1:
                    ...
                    for (int i3 = 0; i3 < size; i3++) {
                        ...
                        lwVar.BaseResponse = baseResponse;
                    }
                    AppMethodBeat.o(72423);
                    return 0;
                case 2:
                    lwVar.pTZ = aVar3.UbS.zi();
                    AppMethodBeat.o(72423);
                    return 0;
                case 3:
                    lwVar.pUa = aVar3.UbS.readString();
                    AppMethodBeat.o(72423);
                    return 0;
                case 4:
                case 5:
