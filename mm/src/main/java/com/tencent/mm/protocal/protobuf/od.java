...
public final class od extends dpc {
    public String KTG;
    public String dJa;
    public int ret;
            ...
            switch (intValue) {
                case 1:
                    ...
                    for (int i3 = 0; i3 < size; i3++) {
                        ...
                        odVar.BaseResponse = baseResponse;
                    }
                    AppMethodBeat.o(224533);
                    return 0;
                case 2:
                    odVar.ret = aVar3.UbS.zi();
                    AppMethodBeat.o(224533);
                    return 0;
                case 3:
                    odVar.dJa = aVar3.UbS.readString();
                    AppMethodBeat.o(224533);
                    return 0;
                case 4:
                    odVar.KTG = aVar3.UbS.readString();
                    AppMethodBeat.o(224533);
                    return 0;
                default:
                    AppMethodBeat.o(224533);
