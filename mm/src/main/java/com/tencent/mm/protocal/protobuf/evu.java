...
public final class evu extends a {
    public euz NtA;
    public int NtB;
    public int NtC;
    ...
    public final int op(int i2, Object... objArr) {
        ...
        if (i2 == 0) {
            ...
            int nh = (this.NtA != null ? g.a.a.a.nh(1, this.NtA.computeSize()) + 0 : 0) + g.a.a.b.b.a.bu(2, this.NtB) + g.a.a.b.b.a.bu(3, this.NtC);
            AppMethodBeat.o(147808);
            return nh;
        } else if (i2 == 2) {
            ...
            switch (intValue) {
                case 1:
                    ...
                    return 0;
                case 2:
                    evu.NtB = aVar3.UbS.zi();
                    AppMethodBeat.o(147808);
                    return 0;
                case 3:
                    evu.NtC = aVar3.UbS.zi();
                    AppMethodBeat.o(147808);
                    return 0;
                default:
                    AppMethodBeat.o(147808);
