...
public final class cdo extends dop {
    public LinkedList<cdn> oTA = new LinkedList<>();
    public int oTz;
            ...
            switch (intValue) {
                case 1:
                    ...
                    for (int i3 = 0; i3 < size; i3++) {
                        ...
                        cdo.BaseRequest = jrVar;
                    }
                    AppMethodBeat.o(155426);
                    return 0;
                case 2:
                    cdo.oTz = aVar3.UbS.zi();
                    AppMethodBeat.o(155426);
                    return 0;
                case 3:
                    ...
                    for (int i4 = 0; i4 < size2; i4++) {
                        ...
                        for (boolean z2 = true; z2; z2 = cdn.populateBuilderWithField(aVar5, cdn, dop.getNextFieldNumber(aVar5))) {
                        }
                        cdo.oTA.add(cdn);
                    }
                    AppMethodBeat.o(155426);
