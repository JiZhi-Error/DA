...
public final class ewb extends a {
    public euz NtA;
    public evs NtK;
    ...
    public final int op(int i2, Object... objArr) {
        ...
        if (i2 == 0) {
            ...
            if (this.NtK != null) {
                aVar.ni(2, this.NtK.computeSize());
                this.NtK.writeFields(aVar);
            }
            AppMethodBeat.o(147815);
            return 0;
        } else if (i2 == 1) {
            int nh = this.NtA != null ? g.a.a.a.nh(1, this.NtA.computeSize()) + 0 : 0;
            if (this.NtK != null) {
                nh += g.a.a.a.nh(2, this.NtK.computeSize());
            }
            AppMethodBeat.o(147815);
            return nh;
        } else if (i2 == 2) {
            ...
            switch (intValue) {
                ...
                case 2:
                    ...
                    for (int i4 = 0; i4 < size2; i4++) {
                        ...
                        for (boolean z2 = true; z2; z2 = evs.populateBuilderWithField(aVar5, evs, a.getNextFieldNumber(aVar5))) {
                        }
                        ewb.NtK = evs;
                    }
                    AppMethodBeat.o(147815);
