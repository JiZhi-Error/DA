...
public final class dhq extends dpc {
    public bl MMy;
    public int pTZ;
    public String pUa;
            ...
            switch (intValue) {
                case 1:
                    ...
                    for (int i3 = 0; i3 < size; i3++) {
                        ...
                        dhq.BaseResponse = baseResponse;
                    }
                    AppMethodBeat.o(91647);
                    return 0;
                case 2:
                    dhq.pTZ = aVar3.UbS.zi();
                    AppMethodBeat.o(91647);
                    return 0;
                case 3:
                    dhq.pUa = aVar3.UbS.readString();
                    AppMethodBeat.o(91647);
                    return 0;
                case 4:
                    ...
                    for (int i4 = 0; i4 < size2; i4++) {
                        ...
                        for (boolean z2 = true; z2; z2 = blVar.populateBuilderWithField(aVar5, blVar, dpc.getNextFieldNumber(aVar5))) {
                        }
                        dhq.MMy = blVar;
                    }
                    AppMethodBeat.o(91647);
