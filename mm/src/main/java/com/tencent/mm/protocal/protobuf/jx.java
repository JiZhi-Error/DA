...
public final class jx extends dpc {
    public LinkedList<afl> oTA = new LinkedList<>();
    public int oTz;
            ...
            switch (intValue) {
                case 1:
                    ...
                    for (int i3 = 0; i3 < size; i3++) {
                        ...
                        jxVar.BaseResponse = baseResponse;
                    }
                    AppMethodBeat.o(127435);
                    return 0;
                case 2:
                    jxVar.oTz = aVar3.UbS.zi();
                    AppMethodBeat.o(127435);
                    return 0;
                case 3:
                    ...
                    for (int i4 = 0; i4 < size2; i4++) {
                        ...
                        for (boolean z2 = true; z2; z2 = afl.populateBuilderWithField(aVar5, afl, dpc.getNextFieldNumber(aVar5))) {
                        }
                        jxVar.oTA.add(afl);
                    }
                    AppMethodBeat.o(127435);
