...
public final class asg extends dpc {
    ...
    public final int op(int i2, Object... objArr) {
        ...
        if (i2 == 0) {
            ...
            int bu = nh + g.a.a.b.b.a.bu(4, this.continueFlag) + g.a.a.b.b.a.bu(5, this.LDr);
            AppMethodBeat.o(168981);
            return bu;
        } else if (i2 == 2) {
            this.LCI.clear();
            ...
            switch (intValue) {
                ...
                case 2:
                    ...
                    for (int i4 = 0; i4 < size2; i4++) {
                        ...
                        asg.LCI.add(finderContact);
                    }
                    AppMethodBeat.o(168981);
                    return 0;
                case 3:
                    asg.lastBuffer = aVar3.UbS.hPo();
                    AppMethodBeat.o(168981);
                    return 0;
                case 4:
                    asg.continueFlag = aVar3.UbS.zi();
                    AppMethodBeat.o(168981);
                    return 0;
                case 5:
                    asg.LDr = aVar3.UbS.zi();
                    AppMethodBeat.o(168981);
                    return 0;
                default:
                    AppMethodBeat.o(168981);
