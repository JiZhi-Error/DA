...
public final class fhb extends dop {
    public aov LBM;
    ...
    public final int op(int i2, Object... objArr) {
        ...
        if (i2 == 0) {
            ...
            if (this.nickname != null) {
                nh += g.a.a.b.b.a.f(3, this.nickname);
            }
            if (this.qFV != null) {
            ...
            switch (intValue) {
                ...
                case 2:
                    ...
                    return 0;
                case 3:
                    fhb.nickname = aVar3.UbS.readString();
                    AppMethodBeat.o(259361);
                    return 0;
                case 4:
                    fhb.qFV = aVar3.UbS.readString();
                    AppMethodBeat.o(259361);
                    return 0;
                default:
                    AppMethodBeat.o(259361);
