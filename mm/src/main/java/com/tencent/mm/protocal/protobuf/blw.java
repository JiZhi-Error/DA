...
public final class blw extends dpc {
    public long LUH;
    public boolean LUI;
    public long LUJ;
    ...
    public final int op(int i2, Object... objArr) {
        ...
        if (i2 == 0) {
            ...
            aVar.e(7, 8, this.LUK);
            if (this.LUL != null) {
                aVar.ni(8, this.LUL.computeSize());
                this.LUL.writeFields(aVar);
            }
            AppMethodBeat.o(201333);
            return 0;
        } else if (i2 == 1) {
            ...
            if (this.LUL != null) {
                c2 += g.a.a.a.nh(8, this.LUL.computeSize());
            }
            AppMethodBeat.o(201333);
            return c2;
        } else if (i2 == 2) {
            ...
            switch (intValue) {
                case 1:
                    ...
                    for (int i3 = 0; i3 < size; i3++) {
                        ...
                        blw.BaseResponse = baseResponse;
                    }
                    AppMethodBeat.o(201333);
                    return 0;
                case 2:
                    blw.LUH = aVar3.UbS.zl();
                    AppMethodBeat.o(201333);
                    return 0;
                case 3:
                    blw.pUa = aVar3.UbS.readString();
                    AppMethodBeat.o(201333);
                    return 0;
                case 4:
                    blw.LUI = aVar3.UbS.yZ();
                    AppMethodBeat.o(201333);
                    return 0;
                case 5:
                    blw.LUJ = aVar3.UbS.zl();
                    AppMethodBeat.o(201333);
                    return 0;
                case 6:
                    blw.title = aVar3.UbS.readString();
                    AppMethodBeat.o(201333);
                    return 0;
                case 7:
