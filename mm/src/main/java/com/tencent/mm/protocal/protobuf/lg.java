...
public final class lg extends dpc {
    public boolean KPb;
    ...
    public final int op(int i2, Object... objArr) {
        ...
        if (i2 == 0) {
            ...
            int nh = (this.BaseResponse != null ? g.a.a.a.nh(1, this.BaseResponse.computeSize()) + 0 : 0) + g.a.a.b.b.a.fS(2) + 1 + g.a.a.a.c(3, 8, this.KPc);
            AppMethodBeat.o(153265);
            return nh;
        } else if (i2 == 2) {
            this.KPc.clear();
