...
public final class alb extends dpc {
    public int KLp;
    ...
    public final int op(int i2, Object... objArr) {
        ...
        if (i2 == 0) {
            ...
            int bu = nh + g.a.a.b.b.a.bu(4, this.oTW) + g.a.a.b.b.a.bu(5, this.KLp);
            if (this.hio != null) {
            ...
            switch (intValue) {
                case 1:
                    ...
                    for (int i3 = 0; i3 < size; i3++) {
                        ...
                        alb.BaseResponse = baseResponse;
                    }
                    AppMethodBeat.o(256408);
                    return 0;
                case 2:
                    alb.rBx = aVar3.UbS.zi();
                    AppMethodBeat.o(256408);
                    return 0;
                case 3:
                    alb.UserName = aVar3.UbS.readString();
                    AppMethodBeat.o(256408);
                    return 0;
                case 4:
                    alb.oTW = aVar3.UbS.zi();
                    AppMethodBeat.o(256408);
                    return 0;
                case 5:
                    alb.KLp = aVar3.UbS.zi();
                    AppMethodBeat.o(256408);
                    return 0;
                case 6:
                    alb.hio = aVar3.UbS.readString();
                    AppMethodBeat.o(256408);
                    return 0;
                default:
                    AppMethodBeat.o(256408);
