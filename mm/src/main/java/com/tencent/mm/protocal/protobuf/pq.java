...
public final class pq extends dop {
    public String KUk;
    public int KWE;
    public String KWF;
    public long KWz;
            ...
            switch (intValue) {
                case 1:
                    ...
                    for (int i3 = 0; i3 < size; i3++) {
                        ...
                        pqVar.BaseRequest = jrVar;
                    }
                    AppMethodBeat.o(224535);
                    return 0;
                case 2:
                    pqVar.KWz = aVar3.UbS.zl();
                    AppMethodBeat.o(224535);
                    return 0;
                case 3:
                    pqVar.KWE = aVar3.UbS.zi();
                    AppMethodBeat.o(224535);
                    return 0;
                case 4:
                    pqVar.KUk = aVar3.UbS.readString();
                    AppMethodBeat.o(224535);
                    return 0;
                case 5:
                    pqVar.KWF = aVar3.UbS.readString();
                    AppMethodBeat.o(224535);
                    return 0;
                default:
                    AppMethodBeat.o(224535);
