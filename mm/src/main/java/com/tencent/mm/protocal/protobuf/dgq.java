...
public final class dgq extends dop {
    public int Lqj;
    public String Mzp;
    public int Mzq;
            ...
            switch (intValue) {
                case 1:
                    ...
                    for (int i3 = 0; i3 < size; i3++) {
                        ...
                        dgq.BaseRequest = jrVar;
                    }
                    AppMethodBeat.o(82465);
                    return 0;
                case 2:
                    dgq.Mzp = aVar3.UbS.readString();
                    AppMethodBeat.o(82465);
                    return 0;
                case 3:
                    dgq.Mzq = aVar3.UbS.zi();
                    AppMethodBeat.o(82465);
                    return 0;
                case 4:
                    dgq.Mzr.add(aVar3.UbS.readString());
                    AppMethodBeat.o(82465);
                    return 0;
                case 5:
                    dgq.Lqj = aVar3.UbS.zi();
                    AppMethodBeat.o(82465);
                    return 0;
                default:
                    AppMethodBeat.o(82465);
