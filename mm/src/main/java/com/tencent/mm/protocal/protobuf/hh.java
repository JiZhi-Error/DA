...
public final class hh extends dpc {
    public String KKR;
    public String hik;
    ...
    public final int op(int i2, Object... objArr) {
        ...
        if (i2 == 0) {
            ...
            if (this.BaseResponse == null) {
                ...
                b bVar5 = new b("Not all required fields were included: ReqKey");
                AppMethodBeat.o(104746);
                throw bVar5;
            } else if (this.hik == null) {
            ...
            switch (intValue) {
                case 1:
                    ...
                    for (int i3 = 0; i3 < size; i3++) {
                        ...
                        hhVar.BaseResponse = baseResponse;
                    }
                    AppMethodBeat.o(104746);
                    return 0;
                case 2:
                    hhVar.KKR = aVar3.UbS.readString();
                    AppMethodBeat.o(104746);
                    return 0;
                case 3:
                    hhVar.hik = aVar3.UbS.readString();
                    AppMethodBeat.o(104746);
                    return 0;
                default:
                    AppMethodBeat.o(104746);
