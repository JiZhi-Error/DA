...
public final class bev extends dpc {
    public adq LjX;
    public int pTZ;
    public String pUa;
    ...
    public final int op(int i2, Object... objArr) {
        ...
        if (i2 == 0) {
            ...
            if (this.LjX != null) {
                aVar.ni(4, this.LjX.computeSize());
            ...
            if (this.LjX != null) {
                nh += g.a.a.a.nh(4, this.LjX.computeSize());
            }
            AppMethodBeat.o(91469);
            return nh;
        } else if (i2 == 2) {
            ...
            switch (intValue) {
                case 1:
                    ...
                    for (int i3 = 0; i3 < size; i3++) {
                        ...
                        bev.BaseResponse = baseResponse;
                    }
                    AppMethodBeat.o(91469);
                    return 0;
                case 2:
                    bev.pTZ = aVar3.UbS.zi();
                    AppMethodBeat.o(91469);
                    return 0;
                case 3:
                    bev.pUa = aVar3.UbS.readString();
                    AppMethodBeat.o(91469);
                    return 0;
                case 4:
