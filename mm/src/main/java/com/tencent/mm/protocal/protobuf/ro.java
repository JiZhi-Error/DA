...
public final class ro extends dpc {
    public int KYZ;
    public int pTZ;
    public String pUa;
    ...
    public final int op(int i2, Object... objArr) {
        ...
        if (i2 == 0) {
            ...
            int bu = nh + g.a.a.b.b.a.bu(4, this.KYZ);
            AppMethodBeat.o(91382);
            return bu;
        } else if (i2 == 2) {
            ...
            switch (intValue) {
                case 1:
                    ...
                    for (int i3 = 0; i3 < size; i3++) {
                        ...
                        roVar.BaseResponse = baseResponse;
                    }
                    AppMethodBeat.o(91382);
                    return 0;
                case 2:
                    roVar.pTZ = aVar3.UbS.zi();
                    AppMethodBeat.o(91382);
                    return 0;
                case 3:
                    roVar.pUa = aVar3.UbS.readString();
                    AppMethodBeat.o(91382);
                    return 0;
                case 4:
                    roVar.KYZ = aVar3.UbS.zi();
                    AppMethodBeat.o(91382);
                    return 0;
                default:
                    AppMethodBeat.o(91382);
