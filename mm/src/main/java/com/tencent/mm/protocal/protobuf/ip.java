...
public final class ip extends dop {
    public int KMC;
            ...
            switch (intValue) {
                case 1:
                    ...
                    for (int i3 = 0; i3 < size; i3++) {
                        ...
                        ipVar.BaseRequest = jrVar;
                    }
                    AppMethodBeat.o(32134);
                    return 0;
                case 2:
                    ipVar.KMC = aVar3.UbS.zi();
                    AppMethodBeat.o(32134);
                    return 0;
                case 3:
                    ...
                    return 0;
                case 4:
                    ipVar.KME = aVar3.UbS.readString();
                    AppMethodBeat.o(32134);
                    return 0;
                case 5:
                    ipVar.KMF = aVar3.UbS.readString();
                    AppMethodBeat.o(32134);
                    return 0;
                case 6:
                    ipVar.Scene = aVar3.UbS.zi();
                    AppMethodBeat.o(32134);
                    return 0;
                case 7:
                    ipVar.oTS = aVar3.UbS.zl();
                    AppMethodBeat.o(32134);
                    return 0;
                case 8:
                    ipVar.KMG = aVar3.UbS.readString();
                    AppMethodBeat.o(32134);
                    return 0;
                default:
                    AppMethodBeat.o(32134);
