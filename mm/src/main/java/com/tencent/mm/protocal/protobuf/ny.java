...
public final class ny extends dop {
    public String KTt;
    public String dDv;
    public int offset;
    ...
    public final int op(int i2, Object... objArr) {
        ...
        if (i2 == 0) {
            ...
            if (this.dDv != null) {
                nh += g.a.a.b.b.a.f(3, this.dDv);
            }
            int bu = nh + g.a.a.b.b.a.bu(4, this.offset);
            AppMethodBeat.o(124422);
            return bu;
        } else if (i2 == 2) {
            ...
            switch (intValue) {
                case 1:
                    ...
                    for (int i3 = 0; i3 < size; i3++) {
                        ...
                        nyVar.BaseRequest = jrVar;
                    }
                    AppMethodBeat.o(124422);
                    return 0;
                case 2:
                    nyVar.KTt = aVar3.UbS.readString();
                    AppMethodBeat.o(124422);
                    return 0;
                case 3:
                    nyVar.dDv = aVar3.UbS.readString();
                    AppMethodBeat.o(124422);
                    return 0;
                case 4:
                    nyVar.offset = aVar3.UbS.zi();
                    AppMethodBeat.o(124422);
                    return 0;
                default:
                    AppMethodBeat.o(124422);
