...
public final class bbc extends dpc {
    public b LDs;
    public LinkedList<aqk> LKG = new LinkedList<>();
    public int tUC;
    ...
    public final int op(int i2, Object... objArr) {
        ...
        if (i2 == 0) {
            ...
            int nh = (this.BaseResponse != null ? g.a.a.a.nh(1, this.BaseResponse.computeSize()) + 0 : 0) + g.a.a.a.c(2, 8, this.LKG);
            if (this.LDs != null) {
            ...
            switch (intValue) {
                ...
                case 2:
                    ...
                    return 0;
                case 3:
                    bbc.LDs = aVar3.UbS.hPo();
                    AppMethodBeat.o(209643);
                    return 0;
                case 4:
                    bbc.tUC = aVar3.UbS.zi();
                    AppMethodBeat.o(209643);
                    return 0;
                default:
                    AppMethodBeat.o(209643);
