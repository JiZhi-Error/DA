...
public final class btq extends dop {
    public bf Lcc;
    public String LhT;
    ...
    public final int op(int i2, Object... objArr) {
        ...
        if (i2 == 0) {
            ...
            if (this.session_id != null) {
                nh += g.a.a.b.b.a.f(4, this.session_id);
            }
            AppMethodBeat.o(91508);
            return nh;
        } else if (i2 == 2) {
            ...
            switch (intValue) {
                ...
                case 2:
                    ...
                    return 0;
                case 3:
                    btq.LhT = aVar3.UbS.readString();
                    AppMethodBeat.o(91508);
                    return 0;
                case 4:
                    btq.session_id = aVar3.UbS.readString();
                    AppMethodBeat.o(91508);
                    return 0;
                default:
                    AppMethodBeat.o(91508);
