...
public class StringCode {
    ...
    public static final String OCR_AUTO_SUCCEED = "ocr_auto_succeed";
    public static final String OCR_AUTO_TIMEOUT = "ocr_auto_timeout";
    public static final String OCR_CAM_BLUR = "ocr_cam_blur";
    public static final String OCR_CARD_CLOSER = "ocr_card_closer";
    public static final String OCR_CARD_FARER = "ocr_card_farer";
    public static final String OCR_MANUAL_SUCCEED = "ocr_manual_succeed";
    public static final String OCR_NO_CARD = "ocr_no_card";
