        ...
        try {
            ...
            if (sQLiteDatabase2 != null) {
                ...
                try {
                    ...
                    this.mMode = i2;
                    sQLiteDatabase = com.tencent.wcdb.support.Context.openOrCreateDatabase(this.mContext, this.mName, this.mPassword, this.mCipher, this.mMode, this.mFactory, this.mErrorHandler, i3);
