...
public final class ServerProtocol {
    ...
    public static final String getDialogAuthority() {
        ...
        String format = String.format(DIALOG_AUTHORITY_FORMAT, FacebookSdk.getFacebookDomain());
    ...
    public static final String getGraphUrlBase() {
        ...
        String format = String.format(GRAPH_URL_FORMAT, FacebookSdk.getFacebookDomain());
    ...
    public static final String getGraphVideoUrlBase() {
        ...
        String format = String.format(GRAPH_VIDEO_URL_FORMAT, FacebookSdk.getFacebookDomain());
    ...
    public static Bundle getQueryParamsForPlatformActivityIntentWebFallback(String str, int i2, Bundle bundle) {
        ...
        try {
            ...
            Logger.log(LoggingBehavior.DEVELOPER_ERRORS, 6, TAG, "Error creating Url -- ".concat(String.valueOf(e2)));
            bundle2 = null;
        }
    }
}
