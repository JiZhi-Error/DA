...
public class DeviceShareDialogFragment extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle bundle) {
        ...
        View inflate = getActivity().getLayoutInflater().inflate(R.layout.vg, (ViewGroup) null);
        this.progressBar = (ProgressBar) inflate.findViewById(R.id.gl_);
        ...
        ((TextView) inflate.findViewById(R.id.b85)).setText(Html.fromHtml(getString(R.string.b7y)));
    ...
    private Bundle getGraphParametersForShareContent() {
        ...
        if (shareContent2 == null) {
            ...
            return null;
        } else if (shareContent2 instanceof ShareLinkContent) {
            Bundle create = WebDialogParameters.create((ShareLinkContent) shareContent2);
            AppMethodBeat.o(7992);
            return create;
        } else if (shareContent2 instanceof ShareOpenGraphContent) {
            Bundle create2 = WebDialogParameters.create((ShareOpenGraphContent) shareContent2);
            AppMethodBeat.o(7992);
            return create2;
        } else {
            AppMethodBeat.o(7992);
