...
final class zza extends Api.AbstractClientBuilder<SignInClientImpl, SignInOptions> {
    ...
    public final /* synthetic */ SignInClientImpl buildClient(Context context, Looper looper, ClientSettings clientSettings, SignInOptions signInOptions, GoogleApiClient.ConnectionCallbacks connectionCallbacks, GoogleApiClient.OnConnectionFailedListener onConnectionFailedListener) {
        ...
        SignInClientImpl signInClientImpl = new SignInClientImpl(context, looper, true, clientSettings, signInOptions2 == null ? SignInOptions.DEFAULT : signInOptions2, connectionCallbacks, onConnectionFailedListener);
