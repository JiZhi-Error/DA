...
public interface Channel extends Parcelable {
    ...
    PendingResult<Status> close(GoogleApiClient googleApiClient, int i2);
    ...
    PendingResult<Status> sendFile(GoogleApiClient googleApiClient, Uri uri, long j2, long j3);
}
