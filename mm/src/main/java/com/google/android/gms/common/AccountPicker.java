...
public final class AccountPicker {
    ...
    public static Intent newChooseAccountIntent(Account account, ArrayList<Account> arrayList, String[] strArr, boolean z, String str, String str2, String[] strArr2, Bundle bundle, boolean z2, int i2, int i3) {
        AppMethodBeat.i(4358);
        Intent newChooseAccountIntent = newChooseAccountIntent(account, arrayList, strArr, z, str, str2, strArr2, bundle, z2, i2, i3, null, false);
        AppMethodBeat.o(4358);
        return newChooseAccountIntent;
    }

    public static Intent newChooseAccountIntent(Account account, ArrayList<Account> arrayList, String[] strArr, boolean z, String str, String str2, String[] strArr2, Bundle bundle, boolean z2, int i2, int i3, String str3, boolean z3) {
        ...
        intent.putExtra(EXTRA_OVERRIDE_THEME, i2);
        intent.putExtra(EXTRA_OVERRIDE_CUSTOM_THEME, i3);
