...
public class GoogleSignInOptionsExtensionParcelable extends AbstractSafeParcelable {
    ...
    GoogleSignInOptionsExtensionParcelable(@SafeParcelable.Param(id = 1) int i2, @SafeParcelable.Param(id = 2) @GoogleSignInOptionsExtension.TypeId int i3, @SafeParcelable.Param(id = 3) Bundle bundle) {
        this.versionCode = i2;
        this.zzac = i3;
        this.mBundle = bundle;
    }
