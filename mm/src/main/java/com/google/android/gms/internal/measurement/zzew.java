...
public final class zzew {
    ...
    public static zzex<Long> zzagk = zzex.zzb("measurement.monitoring.sample_period_millis", (long) Util.MILLSECONDS_OF_DAY, (long) Util.MILLSECONDS_OF_DAY);
    public static zzex<Long> zzagl = zzex.zzb("measurement.config.cache_time", (long) Util.MILLSECONDS_OF_DAY, (long) Util.MILLSECONDS_OF_HOUR);
    ...
    public static zzex<Long> zzaha = zzex.zzb("measurement.upload.window_interval", (long) Util.MILLSECONDS_OF_HOUR, (long) Util.MILLSECONDS_OF_HOUR);
    public static zzex<Long> zzahb = zzex.zzb("measurement.upload.interval", (long) Util.MILLSECONDS_OF_HOUR, (long) Util.MILLSECONDS_OF_HOUR);
    ...
    public static zzex<Long> zzahf = zzex.zzb("measurement.alarm_manager.minimum_interval", (long) Util.MILLSECONDS_OF_MINUTE, (long) Util.MILLSECONDS_OF_MINUTE);
    public static zzex<Long> zzahg = zzex.zzb("measurement.upload.stale_data_deletion_interval", (long) Util.MILLSECONDS_OF_DAY, (long) Util.MILLSECONDS_OF_DAY);
