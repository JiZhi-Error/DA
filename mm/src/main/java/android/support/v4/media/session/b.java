    ...
    public static abstract class a extends Binder implements b {
        ...
        public boolean onTransact(int i2, Parcel parcel, Parcel parcel2, int i3) {
            ...
            switch (i2) {
                ...
                case 3:
                    parcel.enforceInterface("android.support.v4.media.session.IMediaSession");
                    a(a.AbstractBinderC0029a.c(parcel.readStrongBinder()));
                    parcel2.writeNoException();
                    return true;
                case 4:
                    parcel.enforceInterface("android.support.v4.media.session.IMediaSession");
                    b(a.AbstractBinderC0029a.c(parcel.readStrongBinder()));
                    parcel2.writeNoException();
                    return true;
                case 5:
                    parcel.enforceInterface("android.support.v4.media.session.IMediaSession");
                ...
                case 10:
                    parcel.enforceInterface("android.support.v4.media.session.IMediaSession");
                    ParcelableVolumeInfo eU = eU();
                    parcel2.writeNoException();
                    if (eU != null) {
                        parcel2.writeInt(1);
                        eU.writeToParcel(parcel2, 1);
                        return true;
                    }
                    parcel2.writeInt(0);
                    return true;
                ...
                case 28:
                    parcel.enforceInterface("android.support.v4.media.session.IMediaSession");
                    PlaybackStateCompat eW = eW();
                    parcel2.writeNoException();
                    if (eW != null) {
                        parcel2.writeInt(1);
                        eW.writeToParcel(parcel2, 1);
                        return true;
                    }
                    parcel2.writeInt(0);
                    return true;
