...
public class ConstraintWidget {
    ...
    public int getOptimizerWrapWidth() {
        ...
        if (this.mMatchConstraintMaxWidth <= 0 || this.mMatchConstraintMaxWidth >= i2) {
            return i2;
        }
    ...
    public int getOptimizerWrapHeight() {
        ...
        if (this.mMatchConstraintMaxHeight <= 0 || this.mMatchConstraintMaxHeight >= i2) {
            return i2;
        }
    ...
    public void updateDrawPosition() {
        ...
        this.mDrawHeight = (this.mY + this.mHeight) - i3;
    }
        ...
        if (type == ConstraintAnchor.Type.CENTER) {
            if (type2 == ConstraintAnchor.Type.CENTER) {
                ...
                if ((anchor == null || !anchor.isConnected()) && (anchor2 == null || !anchor2.isConnected())) {
                    connect(ConstraintAnchor.Type.LEFT, constraintWidget, ConstraintAnchor.Type.LEFT, 0, strength, i3);
                    connect(ConstraintAnchor.Type.RIGHT, constraintWidget, ConstraintAnchor.Type.RIGHT, 0, strength, i3);
                    z = true;
                } else {
                    z = false;
                }
            ...
            if (anchor9.isValidConnection(anchor10)) {
                ...
                anchor9.connect(anchor10, i2, strength, i3);
    ...
    private boolean isChainHead(int i2) {
        int i3 = i2 * 2;
        return (this.mListAnchors[i3].mTarget == null || this.mListAnchors[i3].mTarget.mTarget == this.mListAnchors[i3] || this.mListAnchors[i3 + 1].mTarget == null || this.mListAnchors[i3 + 1].mTarget.mTarget != this.mListAnchors[i3 + 1]) ? false : true;
    }
    ...
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private void applyConstraints(android.support.constraint.solver.LinearSystem r19, boolean r20, android.support.constraint.solver.SolverVariable r21, android.support.constraint.solver.SolverVariable r22, android.support.constraint.solver.widgets.ConstraintWidget.DimensionBehaviour r23, boolean r24, android.support.constraint.solver.widgets.ConstraintAnchor r25, android.support.constraint.solver.widgets.ConstraintAnchor r26, int r27, int r28, int r29, int r30, float r31, boolean r32, boolean r33, int r34, int r35, int r36, float r37, boolean r38) {
        /*
