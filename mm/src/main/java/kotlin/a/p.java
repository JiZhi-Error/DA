...
public class p extends o {
    ...
    public static final <T> void a(List<T> list, Comparator<? super T> comparator) {
        ...
        kotlin.g.b.p.h(list, "$this$sortWith");
        kotlin.g.b.p.h(comparator, "comparator");
        if (list.size() > 1) {
