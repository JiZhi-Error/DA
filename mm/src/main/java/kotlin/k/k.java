...
public class k {
    ...
    public static final void a(boolean z, Number number) {
        ...
        p.h(number, "step");
        if (!z) {
            IllegalArgumentException illegalArgumentException = new IllegalArgumentException("Step must be positive, was: " + number + '.');
